...
//    int ieta0  = cell.ieta();//-41 +41 !=0
    ...
    coder.adc2fC(*digiItr,tool);
    if (verbosity == -22) std::cout << "coder done..." << std::endl;
    if (verbosity == -22) std::cout << "fillDigiAmplitudeHF    coder done..." << std::endl;
    double pedestalaver9 = 0.;
    double pedestalaver4 = 0.;
    double pedestal0 = 0.;
    double pedestal1 = 0.;
  ...
  //////      
      ...
      if (verbosity == -22) std::cout << "fillDigiAmplitudeHF  amplitude = " << amplitude << std::endl;
      timew += (ii+1)*ampldefault;
    }//for 1
    amplitudechannel[sub-1][mdepth-1][ieta+41][iphi] += amplitude;// 0-82 ; 0-71
