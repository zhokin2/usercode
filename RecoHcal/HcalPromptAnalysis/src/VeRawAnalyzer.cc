  ...
  if(nevcounter0 != 0 || nevcounter > 99999 ) {  
	...
	for(int k3 = 0; k3<nphi; k3++) {
	  for(int k2 = 0; k2<neta; k2++) {
		...
		int ietaphi = 0; ietaphi = ((k2+1)-1)*nphi + (k3+1) ;
...
void VeRawAnalyzer::beginJob()
{
  ...
  // 72*82 = 5904     0 - HB; 1 - HE; 2 - HO; 3 - HF;
  h_2DsumADCAmplEtaPhiLs0 = new TH2F("h_2DsumADCAmplEtaPhiLs0"," ", nlsminmax, alsmin, blsmax, 5904, 1., 5905);
  h_2DsumADCAmplEtaPhiLs1 = new TH2F("h_2DsumADCAmplEtaPhiLs1"," ", nlsminmax, alsmin, blsmax, 5904, 1., 5905);
  h_2DsumADCAmplEtaPhiLs2 = new TH2F("h_2DsumADCAmplEtaPhiLs2"," ", nlsminmax, alsmin, blsmax, 5904, 1., 5905);
  h_2DsumADCAmplEtaPhiLs3 = new TH2F("h_2DsumADCAmplEtaPhiLs3"," ", nlsminmax, alsmin, blsmax, 5904, 1., 5905);

  h_2DsumADCAmplEtaPhiLs00 = new TH2F("h_2DsumADCAmplEtaPhiLs00"," ", nlsminmax, alsmin, blsmax, 5904, 1., 5905);
  h_2DsumADCAmplEtaPhiLs10 = new TH2F("h_2DsumADCAmplEtaPhiLs10"," ", nlsminmax, alsmin, blsmax, 5904, 1., 5905);
  h_2DsumADCAmplEtaPhiLs20 = new TH2F("h_2DsumADCAmplEtaPhiLs20"," ", nlsminmax, alsmin, blsmax, 5904, 1., 5905);
  h_2DsumADCAmplEtaPhiLs30 = new TH2F("h_2DsumADCAmplEtaPhiLs30"," ", nlsminmax, alsmin, blsmax, 5904, 1., 5905);
