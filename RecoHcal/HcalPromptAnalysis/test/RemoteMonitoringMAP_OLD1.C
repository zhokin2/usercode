...
//Bad			     	                 
                   if (Map_Ampl[test][sub][k]->GetBinContent(i,j) > 0.005 )  {
...
// Creating description html file: 
     ...
     htmlFile << "<h3> For more details see https://twiki.cern.ch/twiki/bin/view/CMS/HcalRemoteMonitoring </h3>"<< std::endl;
