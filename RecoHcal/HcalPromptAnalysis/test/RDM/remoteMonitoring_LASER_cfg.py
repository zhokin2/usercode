...
process.Analyzer = cms.EDAnalyzer("VeRawAnalyzer",
                                  ...
                                  ratioHBMax = cms.double(0.80),
                                  ratioHEMin = cms.double(0.10),
                                  ratioHEMax = cms.double(0.80),
                                  ratioHFMin = cms.double(0.00),
                                  ratioHFMax = cms.double(0.70),
                                  ...
                                  rmsHOMin = cms.double(2.0),
                                  rmsHOMax = cms.double(3.5),
                                  ...
                                  TSmeanHEMin = cms.double(3.2),
                                  TSmeanHEMax = cms.double(6.0),
                                  TSmeanHFMin = cms.double(2.0),
                                  TSmeanHFMax = cms.double(7.0),
                                  TSmeanHOMin = cms.double(3.0),
                                  TSmeanHOMax = cms.double(6.0),
                                  ...
                                  ADCAmplHBMax = cms.double(50.),
                                  ADCAmplHEMin = cms.double(0.),
                                  ADCAmplHEMax = cms.double(200.),
                                  ADCAmplHFMin = cms.double(0.),
                                  ADCAmplHFMax = cms.double(200.),
