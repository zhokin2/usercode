...
##       how to run: 
#
## cmsRun remoteMonitoring_TEST_cfg.py 286590 /store/group/dpg_hcal/comm_hcal/USC /store/group/dpg_hcal/comm_hcal/USC /afs/cern.ch/work/z/zhokin/hcal/cmt8/CMSSW_9_0_0_pre4/src/RecoHcal/HcalPromptAnalysis/test/RDM/test
#
#
...
#'file:/afs/cern.ch/work/z/zhokin/hcal/cmt7/CMSSW_8_1_0_pre10/src/RecoHcal/HcalPromptAnalysis/test/RDM/USC_280702.root'
#
...
process.Analyzer = cms.EDAnalyzer("VeRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  # 
                                  flagupgradeqie1011 = cms.int32(9),
                                  #end upgrade: ---------------------------------------------------------
                                  #
                                  #
