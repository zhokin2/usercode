...
//	TFile *hfile1= new TFile("LED_280702.root", "READ");        
	...
	//    getchar();
	//
          TPostScript psfile ("zadcamplIterMethodEnoPhiNorm.ps", 111);
...
j-41 in histo
   18   28 (11)           16    29
      ...
      c1->cd(1);
      TH2F *maprphinorm1HE1= (TH2F*)hfile1->Get("h_mapenophinorm_HE1");maprphinorm1HE1->Sumw2();
      ...
      c1->cd(2);
      TH2F *maprphinorm1HE2= (TH2F*)hfile1->Get("h_mapenophinorm_HE2");maprphinorm1HE2->Sumw2();
      ...
      c1->cd(3);
      TH2F *maprphinorm1HE3= (TH2F*)hfile1->Get("h_mapenophinorm_HE3");maprphinorm1HE3->Sumw2();
      ...
      c1->cd(4);
      TH2F *maprphinorm1HE4= (TH2F*)hfile1->Get("h_mapenophinorm_HE4");maprphinorm1HE4->Sumw2();
      ...
      c1->cd(5);
      TH2F *maprphinorm1HE5= (TH2F*)hfile1->Get("h_mapenophinorm_HE5");maprphinorm1HE5->Sumw2();
...
//    gPad->SetLogy();
      ...
      c1->cd(6);
      TH2F *maprphinorm1HE6= (TH2F*)hfile1->Get("h_mapenophinorm_HE6");maprphinorm1HE6->Sumw2();
      ...
      c1->cd(7);
      TH2F *maprphinorm1HE7= (TH2F*)hfile1->Get("h_mapenophinorm_HE7");maprphinorm1HE7->Sumw2();
    ...
    //========================================================================================== 2
    //================
    //====================================================================== PHI normalization & put R into massive alexhe
      c1->Clear();
      c1->Divide(1,3);
	...
	double sumoverphi0=0;int nsumoverphi0=0;double sumoverphi1=0;int nsumoverphi1=0;double sumoverphi2=0;int nsumoverphi2=0;double sumoverphi3=0;int nsumoverphi3=0;
	double sumoverphi4=0;int nsumoverphi4=0;double sumoverphi5=0;int nsumoverphi5=0;double sumoverphi6=0;int nsumoverphi6=0;
	for(int jphi=0;jphi<njphi;jphi++){
	  ...
	  if(alexhe[0][jeta][jphi] > 0.) {sumoverphi0 += alexhe[0][jeta][jphi];++nsumoverphi0;}
	  if(alexhe[1][jeta][jphi] > 0.) {sumoverphi1 += alexhe[1][jeta][jphi];++nsumoverphi1;}
	  if(alexhe[2][jeta][jphi] > 0.) {sumoverphi2 += alexhe[2][jeta][jphi];++nsumoverphi2;}
	  if(alexhe[3][jeta][jphi] > 0.) {sumoverphi3 += alexhe[3][jeta][jphi];++nsumoverphi3;}
	  if(alexhe[4][jeta][jphi] > 0.) {sumoverphi4 += alexhe[4][jeta][jphi];++nsumoverphi4;}
	  if(alexhe[5][jeta][jphi] > 0.) {sumoverphi5 += alexhe[5][jeta][jphi];++nsumoverphi5;}
	  if(alexhe[6][jeta][jphi] > 0.) {sumoverphi6 += alexhe[6][jeta][jphi];++nsumoverphi6;}
	}// phi	 
	
	// PHI normalization:
	for(int jphi=0;jphi<njphi;jphi++){
	  if(alexhe[0][jeta][jphi] > 0.) alexhe[0][jeta][jphi] /= (sumoverphi0/nsumoverphi0) ;
	  if(alexhe[1][jeta][jphi] > 0.) alexhe[1][jeta][jphi] /= (sumoverphi1/nsumoverphi1) ;
	  if(alexhe[2][jeta][jphi] > 0.) alexhe[2][jeta][jphi] /= (sumoverphi2/nsumoverphi2) ;
	  if(alexhe[3][jeta][jphi] > 0.) alexhe[3][jeta][jphi] /= (sumoverphi3/nsumoverphi3) ;
	  if(alexhe[4][jeta][jphi] > 0.) alexhe[4][jeta][jphi] /= (sumoverphi4/nsumoverphi4) ;
	  if(alexhe[5][jeta][jphi] > 0.) alexhe[5][jeta][jphi] /= (sumoverphi5/nsumoverphi5) ;
	  if(alexhe[6][jeta][jphi] > 0.) alexhe[6][jeta][jphi] /= (sumoverphi6/nsumoverphi6) ;
	}// phi	 
    ...
    //================
	 ...
	 if(jeta-41 > 0) {
      ...
      c1->cd(1);
      TH2F *mapdphinorm1HE1= (TH2F*)hfile1->Get("h_mapenophinorm2_HE1");mapdphinorm1HE1->Sumw2();
      ...
      c1->cd(2);
      TH2F *mapdphinorm1HE2= (TH2F*)hfile1->Get("h_mapenophinorm2_HE2");mapdphinorm1HE2->Sumw2();
      ...
      c1->cd(3);
      TH2F *mapdphinorm1HE3= (TH2F*)hfile1->Get("h_mapenophinorm2_HE3");mapdphinorm1HE3->Sumw2();
      ...
      c1->cd(4);
      TH2F *mapdphinorm1HE4= (TH2F*)hfile1->Get("h_mapenophinorm2_HE4");mapdphinorm1HE4->Sumw2();
      ...
      c1->cd(5);
      TH2F *mapdphinorm1HE5= (TH2F*)hfile1->Get("h_mapenophinorm2_HE5");mapdphinorm1HE5->Sumw2();
...
//    gPad->SetLogy();
      ...
      c1->cd(6);
      TH2F *mapdphinorm1HE6= (TH2F*)hfile1->Get("h_mapenophinorm2_HE6");mapdphinorm1HE6->Sumw2();
      ...
      c1->cd(7);
      TH2F *mapdphinorm1HE7= (TH2F*)hfile1->Get("h_mapenophinorm2_HE7");mapdphinorm1HE7->Sumw2();
    ...
    //========================================================================================== 12
    //================
    //====================================================================== put Vaiance=Dispersia = Sig**2=<R**2> - (<R>)**2 into massive variance
      //                                                                                           = sum(R*R)/N - (sum(R)/N)**2 
      c1->Clear();
      c1->Divide(1,3);
	...
	double sumoverphi4=0;int nsumoverphi4=0;double sumoverphi5=0;int nsumoverphi5=0;double sumoverphi6=0;int nsumoverphi6=0;
	for(int jphi=0;jphi<njphi;jphi++){
	  variance[0][jeta][jphi] = mapdphinormHE1->GetBinContent(jeta+1,jphi+1);
	  variance[1][jeta][jphi] = mapdphinormHE2->GetBinContent(jeta+1,jphi+1);
	  variance[2][jeta][jphi] = mapdphinormHE3->GetBinContent(jeta+1,jphi+1);
	  variance[3][jeta][jphi] = mapdphinormHE4->GetBinContent(jeta+1,jphi+1);
	  variance[4][jeta][jphi] = mapdphinormHE5->GetBinContent(jeta+1,jphi+1);
	  variance[5][jeta][jphi] = mapdphinormHE6->GetBinContent(jeta+1,jphi+1);
	  variance[6][jeta][jphi] = mapdphinormHE7->GetBinContent(jeta+1,jphi+1);
	  if(variance[0][jeta][jphi] > 0.) {sumoverphi0 += variance[0][jeta][jphi];++nsumoverphi0;}
	  if(variance[1][jeta][jphi] > 0.) {sumoverphi1 += variance[1][jeta][jphi];++nsumoverphi1;}
	  if(variance[2][jeta][jphi] > 0.) {sumoverphi2 += variance[2][jeta][jphi];++nsumoverphi2;}
	  if(variance[3][jeta][jphi] > 0.) {sumoverphi3 += variance[3][jeta][jphi];++nsumoverphi3;}
	  if(variance[4][jeta][jphi] > 0.) {sumoverphi4 += variance[4][jeta][jphi];++nsumoverphi4;}
	  if(variance[5][jeta][jphi] > 0.) {sumoverphi5 += variance[5][jeta][jphi];++nsumoverphi5;}
	  if(variance[6][jeta][jphi] > 0.) {sumoverphi6 += variance[6][jeta][jphi];++nsumoverphi6;}
	}// phi	 
	
	// PHI normalization :
	for(int jphi=0;jphi<njphi;jphi++){
	  if(variance[0][jeta][jphi] > 0.) variance[0][jeta][jphi] /= (sumoverphi0/nsumoverphi0) ;
	  if(variance[1][jeta][jphi] > 0.) variance[1][jeta][jphi] /= (sumoverphi1/nsumoverphi1) ;
	  if(variance[2][jeta][jphi] > 0.) variance[2][jeta][jphi] /= (sumoverphi2/nsumoverphi2) ;
	  if(variance[3][jeta][jphi] > 0.) variance[3][jeta][jphi] /= (sumoverphi3/nsumoverphi3) ;
	  if(variance[4][jeta][jphi] > 0.) variance[4][jeta][jphi] /= (sumoverphi4/nsumoverphi4) ;
	  if(variance[5][jeta][jphi] > 0.) variance[5][jeta][jphi] /= (sumoverphi5/nsumoverphi5) ;
	  if(variance[6][jeta][jphi] > 0.) variance[6][jeta][jphi] /= (sumoverphi6/nsumoverphi6) ;
	}// phi	 

      //       variance (D)           = sum(R*R)/N - (sum(R)/N)**2 
	for(int jphi=0;jphi<njphi;jphi++){
	  //	   cout<<"12 12 12   jeta=     "<< jeta <<"   jphi   =     "<<jphi  <<endl;
	  if(variance[0][jeta][jphi] > 0.) fabs( variance[0][jeta][jphi] -= alexhe[0][jeta][jphi]*alexhe[0][jeta][jphi] );
	  if(variance[0][jeta][jphi] < 0.00003) variance[0][jeta][jphi] = 0.000067;
	  if(variance[1][jeta][jphi] > 0.) fabs( variance[1][jeta][jphi] -= alexhe[1][jeta][jphi]*alexhe[1][jeta][jphi] );
	  if(variance[1][jeta][jphi] < 0.00003) variance[1][jeta][jphi] = 0.000067;
	  if(variance[2][jeta][jphi] > 0.) fabs( variance[2][jeta][jphi] -= alexhe[2][jeta][jphi]*alexhe[2][jeta][jphi] );
	  if(variance[2][jeta][jphi] < 0.00003) variance[2][jeta][jphi] = 0.000067;
	  if(variance[3][jeta][jphi] > 0.) fabs( variance[3][jeta][jphi] -= alexhe[3][jeta][jphi]*alexhe[3][jeta][jphi] );
	  if(variance[3][jeta][jphi] < 0.00003) variance[3][jeta][jphi] = 0.000067;
	  if(variance[4][jeta][jphi] > 0.) fabs( variance[4][jeta][jphi] -= alexhe[4][jeta][jphi]*alexhe[4][jeta][jphi] );
	  if(variance[4][jeta][jphi] < 0.00003) variance[4][jeta][jphi] = 0.000067;
	  if(variance[5][jeta][jphi] > 0.) fabs( variance[5][jeta][jphi] -= alexhe[5][jeta][jphi]*alexhe[5][jeta][jphi] );
	  if(variance[5][jeta][jphi] < 0.00003) variance[5][jeta][jphi] = 0.000067;
	  if(variance[6][jeta][jphi] > 0.) fabs( variance[6][jeta][jphi] -= alexhe[6][jeta][jphi]*alexhe[6][jeta][jphi] );
