...
set MPHR=60
set HPD=24
set TARGET="2010-01-01 00:00:01"
...
tac run2000_2010.txt | tr '\n' ', ' | awk -F "," '{for(i=1;i<=NF; i=i+10 ) {for(j=i;j<=i+9;j++) {printf($j)}; printf("\n");}}' | sed s/\"\"/\"\,\"/g  > run2000_2010.txt1
tac run5000_2010.txt | tr '\n' ', ' | awk -F "," '{for(i=1;i<=NF; i=i+10 ) {for(j=i;j<=i+9;j++) {printf($j)}; printf("\n");}}' | sed s/\"\"/\"\,\"/g  > run5000_2010.txt1
tac run10000_2010.txt | tr '\n' ', ' | awk -F "," '{for(i=1;i<=NF; i=i+10 ) {for(j=i;j<=i+9;j++) {printf($j)}; printf("\n");}}' | sed s/\"\"/\"\,\"/g > run10000_2010.txt1

tac days2000_2010.txt | tr '\n' ', ' | sed 's/\, \,/\,/g' | awk -F "," '{for(i=1;i<=NF; i=i+10 ) {for(j=i;j<=i+9;j++) {printf($j",")}; printf("\n");}}' | sed s/,,,,//g > days2000_2010.txt1
tac days5000_2010.txt | tr '\n' ', ' | sed 's/\, \,/\,/g' | awk -F "," '{for(i=1;i<=NF; i=i+10 ) {for(j=i;j<=i+9;j++) {printf($j",")}; printf("\n");}}' | sed s/,,,,//g > days5000_2010.txt1
tac days10000_2010.txt | tr '\n' ', ' | sed 's/\, \,/\,/g' | awk -F "," '{for(i=1;i<=NF; i=i+10 ) {for(j=i;j<=i+9;j++) {printf($j",")}; printf("\n");}}' | sed s/,,,,//g > days10000_2010.txt1
