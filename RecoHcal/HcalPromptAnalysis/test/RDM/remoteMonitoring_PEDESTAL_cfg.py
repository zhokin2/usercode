...
process.Analyzer = cms.EDAnalyzer("VeRawAnalyzer",
                                  ...
                                  ADCAmplHBMax = cms.double(40.),
                                  ADCAmplHEMin = cms.double(0.),
                                  ADCAmplHEMax = cms.double(50.),
                                  ADCAmplHFMin = cms.double(5.),
                                  ADCAmplHFMax = cms.double(50.),
                                  ADCAmplHOMin = cms.double(60.),
