...
process.Analyzer = cms.EDAnalyzer("VeRawAnalyzer",
                                  ...
                                  TSmeanHEMin = cms.double(5.0),
                                  TSmeanHEMax = cms.double(7.0),
                                  TSmeanHFMin = cms.double(3.5),
                                  TSmeanHFMax = cms.double(6.0),
                                  ...
                                  TSpeakHFMin = cms.double(3.5),
                                  TSpeakHFMax = cms.double(7.5),
