...
touch run2000_10000_${YEARTAG}.txt
touch days2000_${YEARTAG}.txt
touch days5000_${YEARTAG}.txt
touch days10000_${YEARTAG}.txt
touch days2000_10000_${YEARTAG}.txt


set diff=0
set MPHR=60
set HPD=24
set TARGET="2011-01-01 00:00:01"
...
if( ${NEV} >= "2000" && ${NEV} < "10000" ) then
#echo " " >> run2000_${YEARTAG}.txt
echo \"${RUN}\" >> run2000_10000_${YEARTAG}.txt
#echo " " >> run2000_${YEARTAG}.txt
echo ${diff1}"., " >> days2000_10000_${YEARTAG}.txt
endif
...
tac run2000_10000_${YEARTAG}.txt | tr '\n' ', ' | awk -F "," '{for(i=1;i<=NF; i=i+10 ) {for(j=i;j<=i+9;j++) {printf($j)}; printf("\n");}}' | sed s/\"\"/\"\,\"/g  > run2000_10000_${YEARTAG}.txt1
...
tac days2000_10000_${YEARTAG}.txt | tr '\n' ', ' | sed 's/\, \,/\,/g' | awk -F "," '{for(i=1;i<=NF; i=i+10 ) {for(j=i;j<=i+9;j++) {printf($j",")}; printf("\n");}}' | sed s/,,,,//g > days2000_10000_${YEARTAG}.txt1
