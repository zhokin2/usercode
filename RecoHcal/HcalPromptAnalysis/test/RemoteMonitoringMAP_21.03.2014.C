...
void RemoteMonitoringMAP(const char* fname = "LED_211006.root", const char* refname = "LED_210378.root")
{
    gROOT->Reset();
...
// Creating each test kind for each subdet html pages:
  ...
  for (int sub=1;sub<=4;sub++) {  //Subdetector: 1-HB, 2-HE, 3-HF, 4-HO
     ofstream htmlFileT,htmlFileC, htmlFileD,htmlFileP ;
     if (sub==1) {htmlFileT.open("HB_Tile.html"); htmlFileC.open("HB_Calib.html");htmlFileD.open("HB_Drift.html");htmlFileP.open("HB_Pedestals.html");}
     if (sub==2) {htmlFileT.open("HE_Tile.html"); htmlFileC.open("HE_Calib.html");htmlFileD.open("HE_Drift.html");htmlFileP.open("HE_Pedestals.html");}
     if (sub==3) {htmlFileT.open("HO_Tile.html"); htmlFileC.open("HO_Calib.html");htmlFileD.open("HO_Drift.html");htmlFileP.open("HO_Pedestals.html");}
     if (sub==4) {htmlFileT.open("HF_Tile.html"); htmlFileC.open("HF_Calib.html");htmlFileD.open("HF_Drift.html");htmlFileP.open("HF_Pedestals.html");}
