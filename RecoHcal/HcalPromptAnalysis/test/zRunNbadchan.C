...
//
   ...
   c1 = new TCanvas("c1","Hcal4test",200,10,700,900);
	...
	if(ccc1>4.1) {
	  icount++;
	  cout<<"Bigger 4.1, depth1_HB iLS = "<<i<<" <Nbcs> per iLS= "<<ccc1<<endl;
	}
      }
	  cout<<"Bigger 0.0, depth1_HB icount = "<<icount0<<endl;
	  cout<<"Bigger 4.1, depth1_HB icount = "<<icount<<endl;
      int icount=0;
      for (int i=1;i<=nx;i++) {
	double ccc1 =  Rate1->GetBinContent(i)   ;
	if(ccc1>4.4) {
	  icount++;
	  //	  cout<<"Bigger 4.4, depth1_HB iLS = "<<i<<" <Nbcs> per iLS= "<<ccc1<<endl;
	}
      }
	  cout<<"Bigger 4.4, depth1_HB icount = "<<icount<<endl;
...
//      aaaaaa1->SetMinimum(0.0001);
	...
	if(ccc1>0.5) {
	  icount++;
	  cout<<"Bigger 2.0, depth4_HO iLS = "<<i<<" <Nbcs> per iLS= "<<ccc1<<endl;
	}
      }
      cout<<"Bigger 0.0, depth4_HO icount = "<<icount0<<endl;
      cout<<"Bigger 0.5, depth4_HO icount = "<<icount<<endl;
      int icount=0;
      for (int i=1;i<=nx;i++) {
	double ccc1 =  Rate6->GetBinContent(i)   ;
	if(ccc1>0.0) {
	...
	if(ccc1>0.6) {
	  icount++;
	  cout<<"Bigger 0.6, depth1_HF iLS = "<<i<<" <Nbcs> per iLS= "<<ccc1<<endl;
	}
      }
      cout<<"Bigger 0.0, depth1_HF icount = "<<icount0<<endl;
      cout<<"Bigger 0.6, depth1_HF icount = "<<icount<<endl;
      int icount=0;
      for (int i=1;i<=nx;i++) {
	double ccc1 =  Rate7->GetBinContent(i)   ;
	if(ccc1>0.0) {
