...
//            Cefz5S->SetMinimum(1.0);
	...
	Rate2->Sumw2();
      ...
      for (int i=1;i<=nx;i++) {
	double ccc1 =  Rate2->GetBinContent(i)   ;
//	if(ccc1>120) cout<<" iLS =     "<< i <<"    6<A> per channel= "<<ccc1<<endl;
      }
...
//            Cefz6S->SetMinimum(1.0);
	...
	Rate2->Sumw2();
      ...
      for (int i=1;i<=nx;i++) {
	double ccc1 =  Rate2->GetBinContent(i)   ;
//	if(ccc1>50) cout<<" iLS =     "<< i <<"    7<A> per channel= "<<ccc1<<endl;
      }
...
//            Cefz7S->SetMinimum(1.0);
	...
	Rate2->Sumw2();
      ...
      Rate2->SetMarkerColor(2);
      Rate2->SetLineColor(0);
      //        Rate2->SetMaximum(360.);
      //        Rate2->SetMinimum(340.);
      Rate2->Draw("Error");
	...
	double ccc1 =  Rate2->GetBinContent(i);
	if(ccc1>4) icount++;
	if(ccc1>4) cout<<"HO iLS =     "<< i <<"    8<A> per channel= "<<ccc1<<endl;
	//	if(ccc1<1.) cout<<"HO ZERO  iLS =     "<< i <<"    8<A> per channel= "<<ccc1<<endl;
      }
      cout<<"HO icount =     "<< icount<< endl;
