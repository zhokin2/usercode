...
//          TPostScript psfile ("zerrors199751.ps", 111);
   ...
   c1 = new TCanvas("c1","Hcal4test",200,10,700,900);
    ...
    //======================================================================
      ...
      c1->cd(4);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_amplFine");
	gPad->SetLogy();
	...
	//   mp3d->SetMinimum(0.8);
	mp3d->Draw("Error");
	TH1F *mp3d= (TH1F*)hfile1->Get("h_amplError");
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	//	mp3d->GetXaxis()->SetTitle("Energy (AnyError) HF");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	...
	c1->Divide(2,2);
      ...
      c1->cd(2);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_error1_HB");
      int nx = mp3d->GetXaxis()->GetNbins();
      cout << "********* h_error1_HB   nx= "  << nx <<   endl;
      double ccc1 =mp3d->GetBinContent(1);
      double ccc2 =mp3d->GetBinContent(2);
      double ccc3 = ccc2/(ccc2+ccc1);
      cout << "********* h_error1_HB   #Ev =  "  << ccc1+ccc2 <<   endl;
      cout << "********* h_error1_HB   ccc3 = "  << ccc3  <<   endl;
      //  Purity->Sumw2();
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("capid  HB");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	//       mp3d->SetFillColor(5);
	...
	mp3d->Draw("Error");
      ...
      c1->cd(3);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_error2_HB");
      int nx = mp3d->GetXaxis()->GetNbins();
      cout << "********* h_error2_HB   nx= "  << nx <<   endl;
      double ccc1 =mp3d->GetBinContent(1);
      double ccc2 =mp3d->GetBinContent(2);
      double ccc3 = ccc2/(ccc2+ccc1);
      cout << "********* h_error2_HB   #Ev =  "  << ccc1+ccc2 <<   endl;
      cout << "********* h_error2_HB   ccc3 = "  << ccc3  <<   endl;
      //  Purity->Sumw2();
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("er  HB");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	//       mp3d->SetFillColor(5);
	...
	mp3d->Draw("Error");
      ...
      c1->cd(4);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_error3_HB");
      int nx = mp3d->GetXaxis()->GetNbins();
      cout << "********* h_error3_HB   nx= "  << nx <<   endl;
      double ccc1 =mp3d->GetBinContent(1);
      double ccc2 =mp3d->GetBinContent(2);
      double ccc3 = ccc2/(ccc2+ccc1);
      cout << "********* h_error3_HB   #Ev =  "  << ccc1+ccc2 <<   endl;
      cout << "********* h_error3_HB   ccc3 = "  << ccc3  <<   endl;
      //  Purity->Sumw2();
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("dv  HB");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	//       mp3d->SetFillColor(5);
	...
	mp3d->Draw("Error");
      ...
      c1->cd(2);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_error1_HE");
      int nx = mp3d->GetXaxis()->GetNbins();
      cout << "********* h_error1_HE   nx= "  << nx <<   endl;
      double ccc1 =mp3d->GetBinContent(1);
      double ccc2 =mp3d->GetBinContent(2);
      double ccc3 = ccc2/(ccc2+ccc1);
      cout << "********* h_error1_HE   ccc3 = "  << ccc3  <<   endl;
      //  Purity->Sumw2();
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("capid  HE");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	//       mp3d->SetFillColor(5);
	...
	mp3d->Draw("Error");
      ...
      c1->cd(3);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_error2_HE");
      int nx = mp3d->GetXaxis()->GetNbins();
      cout << "********* h_error2_HE   nx= "  << nx <<   endl;
      double ccc1 =mp3d->GetBinContent(1);
      double ccc2 =mp3d->GetBinContent(2);
      double ccc3 = ccc2/(ccc2+ccc1);
      cout << "********* h_error2_HE   ccc3 = "  << ccc3  <<   endl;
      //  Purity->Sumw2();
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("er  HE");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	//       mp3d->SetFillColor(5);
	...
	mp3d->Draw("Error");
      ...
      c1->cd(4);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_error3_HE");
      int nx = mp3d->GetXaxis()->GetNbins();
      cout << "********* h_error3_HE   nx= "  << nx <<   endl;
      double ccc1 =mp3d->GetBinContent(1);
      double ccc2 =mp3d->GetBinContent(2);
      double ccc3 = ccc2/(ccc2+ccc1);
      cout << "********* h_error3_HE   ccc3 = "  << ccc3  <<   endl;
      cout << "********************************************************************* "  <<   endl;
      //  Purity->Sumw2();
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("dv  HE");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	//       mp3d->SetFillColor(5);
    ...
    //======================================================================
      ...
      c1->cd(1);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_errorGeneral");
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	...
	mp3d->Draw("Error");
      ...
      c1->cd(2);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_error1");
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("capid  HF");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	//       mp3d->SetFillColor(5);
	...
	mp3d->Draw("Error");
      ...
      c1->cd(3);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_error2");
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("er  HF");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	//       mp3d->SetFillColor(5);
	...
	mp3d->Draw("Error");
      ...
      c1->cd(4);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_error3");
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("dv  HF");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	//       mp3d->SetFillColor(5);
    ...
    //======================================================================
      ...
      c1->cd(1);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_error4_HB");
      int nx = mp3d->GetXaxis()->GetNbins();
      cout << "********* h_error4_HB   nx= "  << nx <<   endl;
      double ccc1 =mp3d->GetBinContent(1);
      double ccc2 =mp3d->GetBinContent(2);
      double ccc3 = ccc2/(ccc2+ccc1);
      cout << "********* h_error4_HB   ccc3 = "  << ccc3  <<   endl;
      //  Purity->Sumw2();
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("capid & er HB");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	//       mp3d->SetFillColor(5);
	...
	mp3d->Draw("Error");
      ...
      c1->cd(2);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_error5_HB");
      int nx = mp3d->GetXaxis()->GetNbins();
      cout << "********* h_error5_HB   nx= "  << nx <<   endl;
      double ccc1 =mp3d->GetBinContent(1);
      double ccc2 =mp3d->GetBinContent(2);
      double ccc3 = ccc2/(ccc2+ccc1);
      cout << "********* h_error5_HB   ccc3 = "  << ccc3  <<   endl;
      //  Purity->Sumw2();
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("capid  & dv HB");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	//       mp3d->SetFillColor(5);
	...
	mp3d->Draw("Error");
      ...
      c1->cd(3);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_error6_HB");
      int nx = mp3d->GetXaxis()->GetNbins();
      cout << "********* h_error6_HB   nx= "  << nx <<   endl;
      double ccc1 =mp3d->GetBinContent(1);
      double ccc2 =mp3d->GetBinContent(2);
      double ccc3 = ccc2/(ccc2+ccc1);
      cout << "********* h_error6_HB   ccc3 = "  << ccc3  <<   endl;
      //  Purity->Sumw2();
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("capid & er & dv HB");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	//       mp3d->SetFillColor(5);
	...
	mp3d->Draw("Error");
      ...
      c1->cd(4);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_error7_HB");
      int nx = mp3d->GetXaxis()->GetNbins();
      cout << "********* h_error7_HB   nx= "  << nx <<   endl;
      double ccc1 =mp3d->GetBinContent(1);
      double ccc2 =mp3d->GetBinContent(2);
      double ccc3 = ccc2/(ccc2+ccc1);
      cout << "********* h_error7_HB   ccc3 = "  << ccc3  <<   endl;
      //  Purity->Sumw2();
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("er & dv  HB");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	//       mp3d->SetFillColor(5);
    ...
    //======================================================================
      ...
      c1->cd(1);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_error4_HE");
      int nx = mp3d->GetXaxis()->GetNbins();
      cout << "********* h_error4_HE   nx= "  << nx <<   endl;
      double ccc1 =mp3d->GetBinContent(1);
      double ccc2 =mp3d->GetBinContent(2);
      double ccc3 = ccc2/(ccc2+ccc1);
      cout << "********* h_error4_HE   ccc3 = "  << ccc3  <<   endl;
      //  Purity->Sumw2();
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("capid & er HE");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	//       mp3d->SetFillColor(5);
	...
	mp3d->Draw("Error");
      ...
      c1->cd(2);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_error5_HE");
      int nx = mp3d->GetXaxis()->GetNbins();
      cout << "********* h_error5_HE   nx= "  << nx <<   endl;
      double ccc1 =mp3d->GetBinContent(1);
      double ccc2 =mp3d->GetBinContent(2);
      double ccc3 = ccc2/(ccc2+ccc1);
      cout << "********* h_error5_HE   ccc3 = "  << ccc3  <<   endl;
      //  Purity->Sumw2();
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("capid  & dv HE");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	//       mp3d->SetFillColor(5);
	...
	mp3d->Draw("Error");
      ...
      c1->cd(3);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_error6_HE");
      int nx = mp3d->GetXaxis()->GetNbins();
      cout << "********* h_error6_HE   nx= "  << nx <<   endl;
      double ccc1 =mp3d->GetBinContent(1);
      double ccc2 =mp3d->GetBinContent(2);
      double ccc3 = ccc2/(ccc2+ccc1);
      cout << "********* h_error6_HE   ccc3 = "  << ccc3  <<   endl;
      //  Purity->Sumw2();
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("capid & er & dv HE");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	//       mp3d->SetFillColor(5);
	...
	mp3d->Draw("Error");
      ...
      c1->cd(4);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_error7_HE");
      int nx = mp3d->GetXaxis()->GetNbins();
      cout << "********* h_error7_HE   nx= "  << nx <<   endl;
      double ccc1 =mp3d->GetBinContent(1);
      double ccc2 =mp3d->GetBinContent(2);
      double ccc3 = ccc2/(ccc2+ccc1);
      cout << "********* h_error7_HE   ccc3 = "  << ccc3  <<   endl;
      //  Purity->Sumw2();
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("er & dv  HE");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	//       mp3d->SetFillColor(5);
...
//      twod1->SetTitle("any Error, HB Depth2 \n");
      ...
      c1->cd(3);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapDepth3Error_HB");
       gPad->SetGridy();
       gPad->SetGridx();
      gPad->SetLogz();
      twod1->SetMarkerStyle(20);
...
//      twod1->SetTitle("any Error, HE Depth3 \n");
    ...
    //======================================================================
      ...
      c1->cd(1);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_fiber0_HB");
	gPad->SetLogy();
	mp3d->Sumw2();
	mp3d->Scale(1./neventsHB);
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("fiber HB");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(2);
	mp3d->SetLineColor(2);
	mp3d->SetMinimum(0.00001);
	mp3d->Draw("Error");
      
     c1->cd(3);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_fiber1_HB");
	gPad->SetLogy();
	mp3d->Sumw2();
	mp3d->Scale(1./neventsHB);
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("fiberChan HB");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	mp3d->SetMinimum(0.00001);
	mp3d->Draw("Error");
     ...
     c1->cd(5);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_fiber2_HB");
	gPad->SetLogy();
	mp3d->Sumw2();
	mp3d->Scale(1./neventsHB);
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("fiberAndChan HB");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	...
	mp3d->Draw("Error");
      ...
      c1->cd(2);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_fiber0_HE");
	gPad->SetLogy();
	mp3d->Sumw2();
	mp3d->Scale(1./neventsHE);
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("fiber HE");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(2);
	mp3d->SetLineColor(2);
	mp3d->SetMinimum(0.00001);
	mp3d->Draw("Error");
     ...
     c1->cd(4);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_fiber1_HE");
	gPad->SetLogy();
	mp3d->Sumw2();
	mp3d->Scale(1./neventsHE);
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("fiberChan HE");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(1);
	mp3d->SetLineColor(1);
	mp3d->SetMinimum(0.00001);
	mp3d->Draw("Error");
     ...
     c1->cd(6);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_fiber2_HE");
	gPad->SetLogy();
	mp3d->Sumw2();
	mp3d->Scale(1./neventsHE);
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("fiberAndChan HE");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(4);
	mp3d->SetLineColor(4);
	mp3d->SetMinimum(0.00001);
    ...
    //======================================================================
      ...
      c1->cd(1);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_repetedcapid_HB");
      int nx = mp3d->GetXaxis()->GetNbins();
      cout << "********* h_repetedcapid_HB   nx= "  << nx <<   endl;
      double ccc1 =mp3d->GetBinContent(1);
      double ccc2 =mp3d->GetBinContent(2);
      double ccc3 = ccc2/(ccc2+ccc1);
      cout << "********* h_repetedcapid_HB   ccc3 = "  << ccc3  <<   endl;
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("repetedcapid HB");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(2);
	mp3d->SetLineColor(2);
	mp3d->Draw("Error");
      ...
      c1->cd(2);
	TH1F *mp3d= (TH1F*)hfile1->Get("h_repetedcapid_HE");
      int nx = mp3d->GetXaxis()->GetNbins();
      cout << "********* h_repetedcapid_HE   nx= "  << nx <<   endl;
      double ccc1 =mp3d->GetBinContent(1);
      double ccc2 =mp3d->GetBinContent(2);
      double ccc3 = ccc2/(ccc2+ccc1);
      cout << "********* h_repetedcapid_HE   ccc3 = "  << ccc3  <<   endl;
	gPad->SetLogy();
	mp3d->SetMarkerStyle(21);
	mp3d->SetMarkerSize(0.4);
	mp3d->GetXaxis()->SetTitle("repetedcapid HE");
	mp3d->GetYaxis()->SetLabelSize(0.04);
	mp3d->SetMarkerColor(2);
	mp3d->SetLineColor(2);
	mp3d->Draw("Error");
