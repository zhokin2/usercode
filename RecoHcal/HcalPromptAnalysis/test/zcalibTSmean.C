...
//	TFile *hfile1= new TFile("test203056.root", "READ");        
	...
	//    getchar();
	//
          TPostScript psfile ("zcalibTSmean.ps", 111);
//
   ...
   c1 = new TCanvas("c1","Hcal4test",200,10,700,900);
    ...
    //======================================================================
      c1->Clear();
      c1->Divide(2,2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapTSmeanCalib_HB");
	...
	Cefz225->Sumw2();
      ...
      c1->cd(2);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_TSmeanCalib_HB");
      gPad->SetLogy();
      aaaaaa1->SetMarkerStyle(20);
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("TSmeanCalib in each event & cell HB\b");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 1.5 || ccc1> 4.5 )  Diffe_HB->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_HB->SetZTitle("<TSmeanCalib> out 1.5 - 4.5  HB \b");
	...
	for (int j=1;j<=ny;j++) {
      ...
      diffAmplitude_HB->SetXTitle("<TSmeanCalib> HB \b");
    ...
    //======================================================================
      c1->Clear();
      c1->Divide(2,2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapTSmeanCalib_HE");
	...
	Ceff->Sumw2();
      ...
      c1->cd(1);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapTSmeanCalib047_HE");
      TH2F *twod0= (TH2F*)hfile1->Get("h_map_HE");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz225->Sumw2();
      ...
      c1->cd(2);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_TSmeanCalib_HE");
      gPad->SetLogy();
      aaaaaa1->SetMarkerStyle(20);
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("TSmeanCalib in each event & cell HE\b");
      aaaaaa1->SetMarkerColor(2);
      aaaaaa1->SetLineColor(2);
      aaaaaa1->SetMinimum(0.8);
      aaaaaa1->Draw("");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 1.0 || ccc1> 4.1  )  Diffe_HE->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_HE->SetZTitle("<TSmeanCalib> out 1.0 - 4.1  HE \b");
	...
	for (int j=1;j<=ny;j++) {
      ...
      diffAmplitude_HE->SetXTitle("<TSmeanCalib> HE \b");
    ...
    //======================================================================
      c1->Clear();
      c1->Divide(2,2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapTSmeanCalib_HO");
	...
	Ceff->Sumw2();
      ...
      c1->cd(1);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapTSmeanCalib047_HO");
      TH2F *twod0= (TH2F*)hfile1->Get("h_map_HO");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz225->Sumw2();
      ...
      c1->cd(2);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_TSmeanCalib_HO");
      gPad->SetLogy();
      aaaaaa1->SetMarkerStyle(20);
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("TSmeanCalib in each event & cell HO\b");
      aaaaaa1->SetMarkerColor(2);
      aaaaaa1->SetLineColor(2);
      aaaaaa1->SetMinimum(0.8);
      aaaaaa1->Draw("");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 1.0 || ccc1> 4.3 )  Diffe_HO->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_HO->SetZTitle("<TSmeanCalib> out 1.0 - 4.3  HO \b");
	...
	for (int j=1;j<=ny;j++) {
      ...
      diffAmplitude_HO->SetXTitle("<TSmeanCalib> HO \b");
    ...
    //======================================================================
      c1->Clear();
      c1->Divide(2,2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapTSmeanCalib_HF");
	...
	Ceff->Sumw2();
      ...
      c1->cd(1);
      TH2F *twod1= (TH2F*)hfile1->Get("h_mapTSmeanCalib047_HF");
      TH2F *twod0= (TH2F*)hfile1->Get("h_map_HF");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz225->Sumw2();
      ...
      c1->cd(2);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_TSmeanCalib_HF");
      gPad->SetLogy();
      aaaaaa1->SetMarkerStyle(20);
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("TSmeanCalib in each event & cell HF\b");
      aaaaaa1->SetMarkerColor(2);
      aaaaaa1->SetLineColor(2);
      aaaaaa1->SetMinimum(0.8);
      aaaaaa1->Draw("");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 0.5 || ccc1> 5.0 )  Diffe_HF->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_HF->SetZTitle("<TSmeanCalib> out 0.5 - 5.0  HF \b");
	...
	for (int j=1;j<=ny;j++) {
      ...
      diffAmplitude_HF->SetXTitle("<TSmeanCalib> HF \b");
