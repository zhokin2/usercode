...
void RemoteMonitoringGLOBAL(const char* fname = "/afs/cern.ch/cms/CAF/CMSALCA/ALCA_HCALCALIB/HCALMONITORING/CMTweb/histos/Global_190707.root")
{
    gROOT->Reset();
...
//    TFile *hfile= new TFile("GlobalHist.root", "READ");
    ...
    // Cut [test][sub][depth]
    double Cut0[7][5][5]={{{0.,0.,0.,0.,0.},{0.,4.6,2.05,0.,0.},{0.,3.3,2.3,1.05,0.},{0.,0.,0.,0.,3.},{0.,0.1,0.1,0.,0.}},  //CapID
                          {{0.,0.,0.,0.,0.},{0.,4.3,4.8,0.,0.},{0.,5.8,5.8,5.9,0.},{0.,0.,0.,0.,4.},{0.,120.,60.,0.,0.}},  //Amplitude   
