...
{
  if (argc<2) {
    std::cout << "use: ./zamt_hf2.exe inputCardsFile [method] [-iphi-VALUE] [-calib-VALUE] [-run-range runNumMin runNumMax] [-run-period runDateMin runDateMax]\n";
