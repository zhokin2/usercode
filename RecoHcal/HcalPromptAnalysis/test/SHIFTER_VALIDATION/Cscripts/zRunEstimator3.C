...
//  TBrowser *b = new TBrowser
	...
	//    getchar();
	//
          TPostScript psfile ("zRunEstimator3.ps", 111);
//
   ...
   c1 = new TCanvas("c1","Hcal4test",200,10,700,900);
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_sumTSmaxALS1");
      gPad->SetLogy();
      ...
      c1->cd(2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_2DsumTSmaxALS1");
      TH2F *twod0= (TH2F*)hfile1->Get("h_2D0sumTSmaxALS1");
      twod1->Sumw2();
      twod0->Sumw2();
...
//            Cefz1->SetMinimum(1.0);
      ...
      c1->cd(3);
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumTSmaxAperLS1");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0TSmaxAperLS1");
      twod3->Sumw2();
      twod2->Sumw2();
...
//      Rate1->SetMaximum(3.04);
//      Rate1->SetMinimum(2.98);
      Rate1->Draw("Error");
	...
	//	if(i == 735) cout<<"Red Dots,  iLS =     "<< i <<"    1<A> per channel= "<<ccc1<<endl;
      ...
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumCutTSmaxAperLS1");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0TSmaxAperLS1");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
...
//      TH1F* ADCAmplperLS = new TH1F("ADCAmplperLS","", maxbins, 1., maxbins+1.);
	...
	//	  if(ccc1>0.)	  cout<<" depth1_HB iLS = "<<i<<" <As> per LS= "<<ccc1<<endl;
      ...
      ADCAmplperLS ->SetMaximum(3.30);
      ADCAmplperLS ->SetMinimum(3.10);
	...
	Rate1->Sumw2();
      ...
      Rate1->SetMarkerColor(2);
      Rate1->SetLineColor(0);
//          Rate1->SetMaximum(2.800);
//          Rate1->SetMinimum(2.56);
      //    Rate1->SetMaximum(8.);
      //    Rate1->SetMinimum(0.);
      Rate1->Draw("Error");
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumTSmaxAperLS1_LSselected");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0TSmaxAperLS1");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
...
//      Rate1->SetMinimum(0.);
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa2= (TH1F*)hfile1->Get("h_sumTSmaxALS2");
      gPad->SetLogy();
      ...
      c1->cd(2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_2DsumTSmaxALS2");
      TH2F *twod0= (TH2F*)hfile1->Get("h_2D0sumTSmaxALS2");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz2->Sumw2();
      ...
      c1->cd(3);
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumTSmaxAperLS2");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0TSmaxAperLS2");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	...
	Rate2->Sumw2();
      ...
      Rate2->Draw("Error");
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumCutTSmaxAperLS2");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0TSmaxAperLS2");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	...
	Rate2->Sumw2();
      ...
      Rate2->SetMarkerColor(2);
      Rate2->SetLineColor(0);
      //    Rate2->SetMaximum(3.000);
      //    Rate2->SetMinimum(2.4);
      Rate2->Draw("Error");
      c1->Update();
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa3= (TH1F*)hfile1->Get("h_sumTSmaxALS3");
      gPad->SetLogy();
      ...
      c1->cd(2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_2DsumTSmaxALS3");
      TH2F *twod0= (TH2F*)hfile1->Get("h_2D0sumTSmaxALS3");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz3->Sumw2();
      ...
      c1->cd(3);
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumTSmaxAperLS3");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0TSmaxAperLS3");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate1 = (TH1F*)twod3->Clone("Rate1");
...
//      Rate1->SetMinimum(2.98);
      Rate1->Draw("Error");
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumCutTSmaxAperLS3");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0TSmaxAperLS3");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa4= (TH1F*)hfile1->Get("h_sumTSmaxALS4");
      gPad->SetLogy();
      ...
      c1->cd(2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_2DsumTSmaxALS4");
      TH2F *twod0= (TH2F*)hfile1->Get("h_2D0sumTSmaxALS4");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz4->Sumw2();
      ...
      c1->cd(3);
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumTSmaxAperLS4");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0TSmaxAperLS4");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate2 = (TH1F*)twod3->Clone("Rate2");
	...
	Rate2->Sumw2();
      ...
      Rate2->SetLineColor(0);
      Rate2->Draw("Error");
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumCutTSmaxAperLS4");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0TSmaxAperLS4");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	...
	Rate2->Sumw2();
      ...
      Rate2->SetMarkerColor(2);
      Rate2->SetLineColor(0);
      //    Rate2->SetMaximum(3.400);
      //    Rate2->SetMinimum(2.7);
      Rate2->Draw("Error");
      c1->Update();
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa5= (TH1F*)hfile1->Get("h_sumTSmaxALS5");
      gPad->SetLogy();
      ...
      c1->cd(2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_2DsumTSmaxALS5");
      TH2F *twod0= (TH2F*)hfile1->Get("h_2D0sumTSmaxALS5");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz5->Sumw2();
      ...
      c1->cd(3);
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumTSmaxAperLS5");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0TSmaxAperLS5");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate2 = (TH1F*)twod3->Clone("Rate2");
	...
	Rate2->Sumw2();
      ...
      Rate2->SetLineColor(0);
      Rate2->Draw("Error");
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumCutTSmaxAperLS5");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0TSmaxAperLS5");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa6= (TH1F*)hfile1->Get("h_sumTSmaxALS6");
      gPad->SetLogy();
      ...
      c1->cd(2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_2DsumTSmaxALS6");
      TH2F *twod0= (TH2F*)hfile1->Get("h_2D0sumTSmaxALS6");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz6->Sumw2();
      ...
      c1->cd(3);
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumTSmaxAperLS6");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0TSmaxAperLS6");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate2 = (TH1F*)twod3->Clone("Rate2");
	...
	Rate2->Sumw2();
      ...
      Rate2->SetMarkerColor(2);
      Rate2->SetLineColor(0);
      Rate2->SetMaximum(2.94);
      Rate2->SetMinimum(2.90);
      Rate2->Draw("Error");
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumCutTSmaxAperLS6");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0TSmaxAperLS6");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	...
	Rate2->Sumw2();
      ...
      Rate2->SetLineColor(0);
      Rate2->Draw("Error");
      //    Rate2->SetMaximum(2.400);
      //    Rate2->SetMinimum(1.4);
      c1->Update();
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa7= (TH1F*)hfile1->Get("h_sumTSmaxALS7");
      gPad->SetLogy();
      ...
      c1->cd(2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_2DsumTSmaxALS7");
      TH2F *twod0= (TH2F*)hfile1->Get("h_2D0sumTSmaxALS7");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz7->Sumw2();
      ...
      c1->cd(3);
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumTSmaxAperLS7");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0TSmaxAperLS7");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate2 = (TH1F*)twod3->Clone("Rate2");
	...
	Rate2->Sumw2();
      ...
      Rate2->SetLineColor(0);
      Rate2->Draw("Error");
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumCutTSmaxAperLS7");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0TSmaxAperLS7");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa8= (TH1F*)hfile1->Get("h_sumTSmaxALS8");
      gPad->SetLogy();
      ...
      c1->cd(2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_2DsumTSmaxALS8");
      TH2F *twod0= (TH2F*)hfile1->Get("h_2D0sumTSmaxALS8");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz8->Sumw2();
      ...
      c1->cd(3);
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumTSmaxAperLS8");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0TSmaxAperLS8");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate2 = (TH1F*)twod3->Clone("Rate2");
	...
	Rate2->Sumw2();
      ...
      Rate2->SetLineColor(0);
//      Rate2->SetMaximum(2.94);
//      Rate2->SetMinimum(2.75);
      Rate2->Draw("Error");
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumCutTSmaxAperLS8");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0TSmaxAperLS8");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
