...
int main(int argc, char *argv[])
{
  ...
  //
 TString MethodName[NMethods] = { "PLOTHB0", "PLOTHB1", "PLOTHB2", "PLOTHB3", "PLOTHB4", "PLOTHB5" };
  //______________________________________________________________________________________________________________________________    
  //______________________________________________________________________________________________________________________________    
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////////  LED runs:
...
*/
// 81+22=103
 const Int_t NMAXM =103;// 
 TString LEDrunsM[NMAXM] = {
"272946","272947","273117","273234","273316","273455","273557","273604","273616","273648",
"273757","273763","273770","273894","273961","274752","274890","275013","275265","275430",
"275457","275697","275807","275864","276081","276402","276416","276461","276462","276463",
"276476","276520","276531","276554","276600","276678","277132","277172","277336","277511",
"278596","278897","279058","279096","279723","279908","280200","280262","280379","281059",
"281362","281458","281645","281735","282462","282726","282775","282776","282847","283010",
"283013","283098","283099","283101","283102","283103","283104","283111","283296","283370",
"283398","283440","283442","283536","284124","284184","284188","284878","285101","285224",
"285349",
...
"305886","306249" 
 ...
 Float_t X0M[NMAXM] = {
    ...
    46.,     49.,      51.,     53.,     55.,     60.,      60.,    62.,     62.,     62.,  
    62.,     63.,      64.,     65.,     66.,     67.,      77.,    78.,     80.,     82.,  
    96.,    102.,     105.,    106.,    115.,    119.,     123.,   124.,    125.,    135.,    
   139.,    140.,     143.,    145.,    153.,    156.,     157.,   157.,    158.,    159.,    
   159.,    160.,     160.,    160.,    160.,    160.,     160.,   160.,    162.,    164.,    
   164.,    165.,     165.,    166.,    175.,    176.,     176.,   186.,    188.,    191.,    
   193.,
   387.,    390.,     396.,    404.,    407.,    416.,     417.,   418.,    419.,    432.,
   440.,    483.,     484.,    492.,    514.,    516.,     518.,   528.,    535.,    538.,
   542.,    550. 
 };// days of year    time points (abscissa) !!!
 //285349  2016-11-15   193.    |            295401   2017-05-28   X= 193+Delta1; Delta1= 15+31+31+28+31+30+28 = 194 ; 193+194=387
 // Delta = Delta1 - 1 = 386, so +  386   (end: 164+386= 550)                      
 /*
...
*/
 ...
 //______________________________________________________________________________
  ...
  //
  Float_t RrangeMIN = 0.800;
  Float_t RrangeMAX = 1.200;
  //Float_t RrangeMIN = 0.870;
  //Float_t RrangeMAX = 1.080;
 ...
 if(yearcase == 2  ) x2=170.00;
  ...
  //(yearcase == 1
  Float_t y1=0.80; Float_t y2=  1.2; //  for 1,2,5,6   for 11,12,15,16
  if(yearcase == 2 ) {
    y1=0.60;
    y2=  1.4;
  }
...
//	cout << "jjj= " << jjj << "     jjj-NMINmM= " << jjj-NMINmM << "     LEDrunsM[jjj]= " << LEDrunsM[jjj] << "     X0M[jjj]= " << X0M[jjj] <<endl;
    ...
    Double_t cutMinA =300.; Double_t cutMaxA = 1300.;  
  //
  // //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //---------------------------------------------------------------------------------------------------------------------
  //-----------------------------------------------------------------------------------------------------
...
*/
  ...
  while (Method<NMethodsToUse+1) {
    ...
    //======================================================================================================= PLOTHB0:  <Aijk>  for each event and all LED runs 
    if(Method == 0 ) {
    ...
    //======================================================================================================= PLOTHB1: <Aijk>  for each event and all LED runs ZOOM
    if(Method == 1 ) {
	...
	for (int kkk=1;kkk<=72;kkk++) {
	  ...
	  //	  else {cout<<"****ERROR for  PLOTHB2:  MMcount is lower 1,  MMcount =   *** " << MMcount  <<   endl;}
	}//for kkk 
      }//for jjj
      
//      //      TLegend leg(.6,.67,.78,.88, " HBP Depth1");
//      TLegend leg(xx1,yy1,xx2,yy2, "HB: R vs t");
//      //      leg.AddEntry(gr1);
//      leg.SetMargin( 0.3 );
//      leg.SetBorderSize(1);
//      leg.DrawClone("Same");
