...
int main(int argc, char *argv[])
{
  ...
  //
 TString MethodName[NMethods] = { "PLOTHF0", "PLOTHF1", "PLOTHF2", "PLOTHF3", "PLOTHF4", "PLOTHF5" };
  //______________________________________________________________________________________________________________________________    
  //______________________________________________________________________________________________________________________________    
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////////  LED runs:
...
*/
 ...
 //______________________________________________________________________________
  ...
  t->SetTextAlign(12);
  //______________________________________________________________________________
  t->DrawLatex(0.9,15.5,"Time dependence of full Amplitude averaged over events of each LED run for some random HF channels");
  ...
  //  Float_t RrangeMIN = 0.200;  Float_t RrangeMAX = 1.800;
    Float_t RrangeMIN = 0.93;Float_t RrangeMAX = 1.07;
  // x(abscissa) for Days
  //(yearcase == 1
  ...
  //(yearcase == 1
  // Float_t y1=0.20; Float_t y2=  1.8; //  for 1,2,5,6   for 11,12,15,16
...
//	cout << "jjj= " << jjj << "     jjj-NMINmM= " << jjj-NMINmM << "     LEDrunsM[jjj]= " << LEDrunsM[jjj] << "     X0M[jjj]= " << X0M[jjj] <<endl;
    ...
    Double_t cutMinA =250.; Double_t cutMaxA = 3000.;  
  //
  // //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //---------------------------------------------------------------------------------------------------------------------
  //-----------------------------------------------------------------------------------------------------
...
*/
      ...
      TH2F* Ceff3= (TH2F*)twod1->Clone("Ceff3");
      TH2F* Ceff4= (TH2F*)twod2->Clone("Ceff4");

    // <Aijk>_runevents:
    Ceff1->Divide(twod1,t0010, 1, 1, "B");  
    Ceff2->Divide(twod2,t0020, 1, 1, "B");  
    Ceff1->Divide(twod3,t0030, 1, 1, "B");  
    Ceff2->Divide(twod4,t0040, 1, 1, "B");  
    ...
    Ceff1->Divide(twod1,t0010, 1, 1, "B");  
    Ceff2->Divide(twod2,t0020, 1, 1, "B");  
    Ceff3->Divide(twod1,t0030, 1, 1, "B");  
    Ceff4->Divide(twod2,t0040, 1, 1, "B");  
	...
	for (int kkk=0;kkk<=ny;kkk++) {
	  ...
	  if( Ceff3->GetBinContent(jjj,kkk) != 0.) cout<<"*111111************ jjj = " << jjj<<   "************* kkk = " << kkk <<endl;
	  if( Ceff4->GetBinContent(jjj,kkk) != 0.) cout<<"*******222****** jjj = " << jjj<<  "************* kkk = " << kkk <<endl;
	}//jjj
      }//kkk
    }// if(verbosity == 2 )
    // fill:
...
*/
  ...
  while (Method<NMethodsToUse+1) {
    ...
    //======================================================================================================= PLOTHF0:  <Aijk>  for each event and all LED runs 
    if(Method == 0 ) {
    ...
    //======================================================================================================= PLOTHF1: <Aijk>  for each event and all LED runs ZOOM
    if(Method == 1 ) {
	...
	for (int kkk=1;kkk<=72;kkk++) {
	  ...
	  //	  else {cout<<"****ERROR for  PLOTHF2:  MMcount is lower 1,  MMcount =   *** " << MMcount  <<   endl;}
	}//for kkk 
      }//for jjj
      
      //      TLegend leg(.6,.67,.78,.88, " HFP Depth1");
      TLegend leg(xx1,yy1,xx2,yy2, "HF: R vs t");
      //      leg.AddEntry(gr1);
      leg.SetMargin( 0.3 );
      leg.SetBorderSize(1);
      leg.DrawClone("Same");
...
//      }// if(verbosity == 2 )
  ...
  //======================================================================================================= 
    TString fdir = "testamt8/";
    //
    TString plotName = fdir + MethodName[Method] +".png";
    c1->SaveAs(plotName);
    cout<<"****PLOTHF "   << Method  <<" drawn **** " <<endl;
