...
//	TFile *hfile1= new TFile("LED_284348.root", "READ");        
//	TFile *hfile2= new TFile("LED_284901.root", "READ");
...
// c1 = new TCanvas("c1","Hcal4test",200,10,700,900);
   ...
   //   }
      c1->cd(1);
      TH2F *twop1= (TH2F*)hfile1->Get("h_mapDepth1TSmeanA225_HB");
      TH2F *twop0= (TH2F*)hfile1->Get("h_mapDepth1_HB");
      twop1->Sumw2();
      twop0->Sumw2();
   ...
   //   }
    ...
    for (int i=1;i<=Ceff->GetXaxis()->GetNbins();i++) {
	  ...
	  //	  Diffe_Depth1_HB->SetBinContent(i,j,ccc1);
	  	  if(ccc1 < 4.4 || ccc1>4.6)  Diffe_Depth1_HB->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth1_HB->SetZTitle("<TSmeanA> out 4.4-4.6- HB Depth1 \b");
      ...
      c1->cd(4);
      TH1F* diffTSmeanA_Depth1_HB = new TH1F("diffTSmeanA_Depth1_HB","", 100, 3.0,6.0);
      for (int i=1;i<=Ceff->GetXaxis()->GetNbins();i++) {
	for (int j=1;j<=Ceff->GetYaxis()->GetNbins();j++) {
    ...
    //======================================================================
      ...
      TH2F *awod1= (TH2F*)hfile1->Get("h_mapDepth2TSmeanA_HB");
      TH2F *awod0= (TH2F*)hfile1->Get("h_mapDepth2_HB");
      awod1->Sumw2();
      awod0->Sumw2();
   //   if(awod0->IsA()->InheritsFrom("TH2F")){
    ...
    //  }
      c1->cd(1);
      TH2F *bwod1= (TH2F*)hfile1->Get("h_mapDepth2TSmeanA225_HB");
      TH2F *bwod0= (TH2F*)hfile1->Get("h_mapDepth2_HB");
      bwod1->Sumw2();
      bwod0->Sumw2();
   ...
   //   }
      ...
      c1->cd(2);
      TH1F *aaaaaa2= (TH1F*)hfile1->Get("h_TSmeanA_HB");
      gPad->SetLogy();
    ...
    for (int i=1;i<=C2ff->GetXaxis()->GetNbins();i++) {
	  ...
	  if(ccc1 < 4.4 || ccc1>4.6)  Diffe_Depth2_HB->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth2_HB->SetZTitle("<TSmeanA> out 4.4-4.6 - HB Depth2 \b");
      ...
      c1->cd(4);
      TH1F* diffTSmeanA_Depth2_HB = new TH1F("diffTSmeanA_Depth2_HB","", 100, 4.0,5.0);
      for (int i=1;i<=C2ff->GetXaxis()->GetNbins();i++) {
	for (int j=1;j<=C2ff->GetYaxis()->GetNbins();j++) {
   ...
   //   }
      c1->cd(1);
      TH2F *dwod1= (TH2F*)hfile1->Get("h_mapDepth1TSmeanA225_HE");
      TH2F *dwod0= (TH2F*)hfile1->Get("h_mapDepth1_HE");
      dwod1->Sumw2();
      dwod0->Sumw2();
   ...
   //   }
    ...
    for (int i=1;i<=C3ff->GetXaxis()->GetNbins();i++) {
	  ...
	  if(ccc1 < 4.4 || ccc1>4.6)  Diffe_Depth1_HE->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth1_HE->SetZTitle("<TSmeanA> out 4.4-4.6 - HE Depth1 \b");
      ...
      c1->cd(4);
      TH1F* diffTSmeanA_Depth1_HE = new TH1F("diffTSmeanA_Depth1_HE","", 100, 4.0,5.0);
      for (int i=1;i<=C3ff->GetXaxis()->GetNbins();i++) {
	for (int j=1;j<=C3ff->GetYaxis()->GetNbins();j++) {
    ...
    //======================================================================
      ...
      TH2F *ewod1= (TH2F*)hfile1->Get("h_mapDepth2TSmeanA_HE");
      TH2F *ewod0= (TH2F*)hfile1->Get("h_mapDepth2_HE");
      ewod1->Sumw2();
      ewod0->Sumw2();
	...
	C4ff->Sumw2();
     // }
      c1->cd(1);
      TH2F *fwod1= (TH2F*)hfile1->Get("h_mapDepth2TSmeanA225_HE");
      TH2F *fwod0= (TH2F*)hfile1->Get("h_mapDepth2_HE");
      fwod1->Sumw2();
      fwod0->Sumw2();
    ...
    //  }
      ...
      c1->cd(2);
      TH1F *aaaaaa4= (TH1F*)hfile1->Get("h_TSmeanA_HE");
      gPad->SetLogy();
    ...
    for (int i=1;i<=C4ff->GetXaxis()->GetNbins();i++) {
	  ...
	  if(ccc1 < 4.4 || ccc1>4.6)  Diffe_Depth2_HE->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth2_HE->SetZTitle("<TSmeanA> out 4.4-4.6 - HE Depth2 \b");
      ...
      c1->cd(4);
      TH1F* diffTSmeanA_Depth2_HE = new TH1F("diffTSmeanA_Depth2_HE","", 100, 4.0,5.0);
      for (int i=1;i<=C4ff->GetXaxis()->GetNbins();i++) {
	for (int j=1;j<=C4ff->GetYaxis()->GetNbins();j++) {
    ...
    //======================================================================
      ...
      TH2F *gwod1= (TH2F*)hfile1->Get("h_mapDepth3TSmeanA_HE");
      TH2F *gwod0= (TH2F*)hfile1->Get("h_mapDepth3_HE");
      gwod1->Sumw2();
      gwod0->Sumw2();
    ...
    //  }
      c1->cd(1);
      TH2F *jwod1= (TH2F*)hfile1->Get("h_mapDepth3TSmeanA225_HE");
      TH2F *jwod0= (TH2F*)hfile1->Get("h_mapDepth3_HE");
      jwod1->Sumw2();
      jwod0->Sumw2();
    ...
    //  }
      ...
      c1->cd(2);
      TH1F *aaaaaa5= (TH1F*)hfile1->Get("h_TSmeanA_HE");
      gPad->SetLogy();
    ...
    for (int i=1;i<=C5ff->GetXaxis()->GetNbins();i++) {
	  ...
	  if(ccc1 < 4.4 || ccc1>4.6)  Diffe_Depth3_HE->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth3_HE->SetZTitle("<TSmeanA> out 4.4-4.6 - HE Depth3 \b");
      ...
      c1->cd(4);
      TH1F* diffTSmeanA_Depth3_HE = new TH1F("diffTSmeanA_Depth3_HE","", 100, 4.0,5.0);
      for (int i=1;i<=C5ff->GetXaxis()->GetNbins();i++) {
	for (int j=1;j<=C5ff->GetYaxis()->GetNbins();j++) {
    ...
    //======================================================================
      ...
      TH2F *iwod1= (TH2F*)hfile1->Get("h_mapDepth1TSmeanA_HF");
      TH2F *iwod0= (TH2F*)hfile1->Get("h_mapDepth1_HF");
      iwod1->Sumw2();
      iwod0->Sumw2();
    ...
    //  }
      c1->cd(1);
      TH2F *kwod1= (TH2F*)hfile1->Get("h_mapDepth1TSmeanA225_HF");
      TH2F *kwod0= (TH2F*)hfile1->Get("h_mapDepth1_HF");
      kwod1->Sumw2();
      kwod0->Sumw2();
    ...
    //  }
      ...
      c1->cd(2);
      TH1F *aaaaaa6= (TH1F*)hfile1->Get("h_TSmeanA_HF");
      gPad->SetLogy();
    ...
    for (int i=1;i<=C6ff->GetXaxis()->GetNbins();i++) {
	  ...
	  if(ccc1 < 1.0 || ccc1>2.5 )  Diffe_Depth1_HF->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth1_HF->SetZTitle("<TSmeanA> out 1.0-2.5   -  HF Depth1 \b");
      ...
      c1->cd(4);
      TH1F* diffTSmeanA_Depth1_HF = new TH1F("diffTSmeanA_Depth1_HF","", 100, 1.0,11.5);
      for (int i=1;i<=C6ff->GetXaxis()->GetNbins();i++) {
	for (int j=1;j<=C6ff->GetYaxis()->GetNbins();j++) {
    ...
    //======================================================================
      ...
      TH2F *lwod1= (TH2F*)hfile1->Get("h_mapDepth2TSmeanA_HF");
      TH2F *lwod0= (TH2F*)hfile1->Get("h_mapDepth2_HF");
      lwod1->Sumw2();
      lwod0->Sumw2();
    ...
    //  }
      c1->cd(1);
      TH2F *mwod1= (TH2F*)hfile1->Get("h_mapDepth2TSmeanA225_HF");
      TH2F *mwod0= (TH2F*)hfile1->Get("h_mapDepth2_HF");
      mwod1->Sumw2();
      mwod0->Sumw2();
    ...
    //  }
      ...
      c1->cd(2);
      TH1F *aaaaaa7= (TH1F*)hfile1->Get("h_TSmeanA_HF");
      gPad->SetLogy();
    ...
    for (int i=1;i<=C7ff->GetXaxis()->GetNbins();i++) {
	  ...
	  if(ccc1 < 1.0 || ccc1>2.5)  Diffe_Depth2_HF->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth2_HF->SetZTitle("<TSmeanA> out 1.0-2.5   -HF Depth2 \b");
      ...
      c1->cd(4);
      TH1F* diffTSmeanA_Depth2_HF = new TH1F("diffTSmeanA_Depth2_HF","", 100, 1.0,2.5);
      for (int i=1;i<=C7ff->GetXaxis()->GetNbins();i++) {
	for (int j=1;j<=C7ff->GetYaxis()->GetNbins();j++) {
    ...
    //======================================================================
      ...
      TH2F *nwod1= (TH2F*)hfile1->Get("h_mapDepth4TSmeanA_HO");
      TH2F *nwod0= (TH2F*)hfile1->Get("h_mapDepth4_HO");
      nwod1->Sumw2();
      nwod0->Sumw2();
    ...
    //  }
      c1->cd(1);
      TH2F *owod1= (TH2F*)hfile1->Get("h_mapDepth4TSmeanA225_HO");
      TH2F *owod0= (TH2F*)hfile1->Get("h_mapDepth4_HO");
      owod1->Sumw2();
      owod0->Sumw2();
   //   if(owod0->IsA()->InheritsFrom("TH2F")){
    ...
    //  }
      ...
      c1->cd(2);
      TH1F *aaaaaa8= (TH1F*)hfile1->Get("h_TSmeanA_HO");
      gPad->SetLogy();
    ...
    for (int i=1;i<=C8ff->GetXaxis()->GetNbins();i++) {
	  ...
	  if(ccc1 < 4.4 || ccc1>4.6)  Diffe_Depth4_HO->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth4_HO->SetZTitle("<TSmeanA> out 4.4-4.6 - HO Depth4 \b");
