...
//	TFile *hfile1= new TFile("Global_228591.root", "READ"); 
//
...
//      twod1->SetTitle("any Error, HB Depth1 \n");
      ...
      //    twod1->SetMaximum(1.000);
      //    twod1->SetMinimum(0.001);
      twod1->SetMaximum(1.);
      twod1->SetMinimum(0.000001);
      twod1->Draw("COLZ");
...
//      twod1->SetTitle("any Error, HF Depth1 \n");
      ...
      twod1->SetMaximum(1.000);
      //    twod1->SetMinimum(0.001);
//      twod1->SetMinimum(0.00001);
      twod1->SetMinimum(0.0000001);
      twod1->Draw("COLZ");
...
//      twod1->SetTitle("any Error, HO Depth4 \n");
   ...
   //   twod1->SetMinimum(0.002);
	...
	c1->Divide(4,3);
      ...
      mp3d->SetMarkerStyle(21);
      mp3d->SetMarkerSize(0.4);
      mp3d->GetXaxis()->SetTitle("CapIdError 1_HB");
      mp3d->GetYaxis()->SetLabelSize(0.04);
      mp3d->SetMarkerColor(1);
      mp3d->SetLineColor(1);
      //       mp3d->SetFillColor(5);
      ...
      mp3d->SetMarkerStyle(21);
      mp3d->SetMarkerSize(0.4);
      mp3d->GetXaxis()->SetTitle("CapIdError 1_HE");
      mp3d->GetYaxis()->SetLabelSize(0.04);
      mp3d->SetMarkerColor(1);
      mp3d->SetLineColor(1);
      //       mp3d->SetFillColor(5);
      ...
      c1->cd(4);
      TH1F *mp3d= (TH1F*)hfile1->Get("h_error1_HO");
      int nx = mp3d->GetXaxis()->GetNbins();
      gPad->SetLogy();
      mp3d->SetMarkerStyle(21);
      mp3d->SetMarkerSize(0.4);
      mp3d->GetXaxis()->SetTitle("CapIdError 1_HO");
      mp3d->GetYaxis()->SetLabelSize(0.04);
      mp3d->SetMarkerColor(1);
      mp3d->SetLineColor(1);
      //       mp3d->SetFillColor(5);
      ...
      mp3d->SetMarkerStyle(21);
      mp3d->SetMarkerSize(0.4);
      mp3d->GetXaxis()->SetTitle("CapIdError 2_HB");
      mp3d->GetYaxis()->SetLabelSize(0.04);
      mp3d->SetMarkerColor(1);
      mp3d->SetLineColor(1);
      //       mp3d->SetFillColor(5);
      ...
      mp3d->SetMarkerStyle(21);
      mp3d->SetMarkerSize(0.4);
      mp3d->GetXaxis()->SetTitle("CapIdError 2_HE");
      mp3d->GetYaxis()->SetLabelSize(0.04);
      mp3d->SetMarkerColor(1);
      mp3d->SetLineColor(1);
      //       mp3d->SetFillColor(5);
      ...
      c1->cd(8);
      TH1F *mp3d= (TH1F*)hfile1->Get("h_error2_HO");
      int nx = mp3d->GetXaxis()->GetNbins();
      gPad->SetLogy();
      mp3d->SetMarkerStyle(21);
      mp3d->SetMarkerSize(0.4);
      mp3d->GetXaxis()->SetTitle("CapIdError 2_HO");
      mp3d->GetYaxis()->SetLabelSize(0.04);
      mp3d->SetMarkerColor(1);
      mp3d->SetLineColor(1);
      //       mp3d->SetFillColor(5);
      ...
      mp3d->SetMarkerStyle(21);
      mp3d->SetMarkerSize(0.4);
      mp3d->GetXaxis()->SetTitle("CapIdError 3_HB");
      mp3d->GetYaxis()->SetLabelSize(0.04);
      mp3d->SetMarkerColor(1);
      mp3d->SetLineColor(1);
      //       mp3d->SetFillColor(5);
      ...
      mp3d->SetMarkerStyle(21);
      mp3d->SetMarkerSize(0.4);
      mp3d->GetXaxis()->SetTitle("CapIdError 3_HE");
      mp3d->GetYaxis()->SetLabelSize(0.04);
      mp3d->SetMarkerColor(1);
      mp3d->SetLineColor(1);
      //       mp3d->SetFillColor(5);
      ...
      c1->cd(12);
      TH1F *mp3d= (TH1F*)hfile1->Get("h_error3_HO");
      int nx = mp3d->GetXaxis()->GetNbins();
      gPad->SetLogy();
      mp3d->SetMarkerStyle(21);
      mp3d->SetMarkerSize(0.4);
      mp3d->GetXaxis()->SetTitle("CapIdError 3_HO");
      mp3d->GetYaxis()->SetLabelSize(0.04);
      mp3d->SetMarkerColor(1);
      mp3d->SetLineColor(1);
      //       mp3d->SetFillColor(5);
