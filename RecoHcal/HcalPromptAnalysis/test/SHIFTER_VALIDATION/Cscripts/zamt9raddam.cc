...
int main(int argc, char *argv[])
{
  ...
  //
 TString MethodName[NMethods] = { "PLOT0", "PLOT1", "PLOT2", "PLOT3", "PLOT4", "PLOT5" };
  //______________________________________________________________________________________________________________________________    
  //______________________________________________________________________________________________________________________________    
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////////  LED runs:
...
*/
// 81+22=103
// re-running with new histo-names for SiPM-HEP17:  first run 286947 (2.03.2017) , except runs 287389 287391 287890 295267
...
*/
 ...
 //______________________________________________________________________________
  ...
  //
  Float_t RrangeMIN = 0.810;
  Float_t RrangeMAX = 1.170;
...
//	cout << "jjj= " << jjj << "     jjj-NMINmM= " << jjj-NMINmM << "     LEDrunsM[jjj]= " << LEDrunsM[jjj] << "     X0M[jjj]= " << X0M[jjj] <<endl;
    ...
    Double_t cutMinA =400.; Double_t cutMaxA = 1200.;  
  //
  // //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //---------------------------------------------------------------------------------------------------------------------
  //-----------------------------------------------------------------------------------------------------
...
//      TLegend leg(xx1,yy1,xx2,yy2, "HE: R vs t");
//      //      leg.AddEntry(gr1);
//      leg.SetMargin( 0.3 );
//      leg.SetBorderSize(1);
//      leg.DrawClone("Same");
