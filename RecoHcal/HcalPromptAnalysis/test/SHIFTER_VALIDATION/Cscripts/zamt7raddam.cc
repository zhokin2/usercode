...
*/
 ...
 const Int_t NMAXM =64;// 
 TString LEDrunsM[NMAXM] = {
"272946","272947","273117","273234","273316","273455","273557","273604","273616","273648",
"273757","273763","273894","273961","274752","274890","275013","275265","275457","275697",
"275807","275864","276081","276416","276476","276520","276531","276554","276600","276678",
"277132","277172","277336","277511","278596","278897","279058","279096","279723","279908",
"280200","280262","280379","281059","281362","281458","281645","281735","282462","282726",
"282776","282847","283013","283111","283296","283398","283442","283536","284124","284188",                                                                        
"284878","285101","285224","285349"
 };//
 Float_t X0M[NMAXM] = {
     1.,      1.,       2.,      3.,      5.,      7.,      10.,    11.,     11.,     11.,  
    15.,     15.,      16.,     17.,     31.,      35.,     39.,    41.,     46.,     49.,      
    51.,     53.,      55.,     60.,     62.,      63.,     64.,    65.,     66.,     67.,      
    77.,     78.,      80.,     82.,     96.,     102.,    105.,   106.,    115.,    119.,    
   123.,    124.,     125.,    135.,    139.,     140.,    143.,   145.,    153.,    156.,              
   157.,    158.,     159.,    160.,    162.,     164.,    165.,   166.,    175.,    176.,
   186.,    188.,     191.,    193. 
 };// days of year    time points (abscissa) !!!
...
*/
 ...
 if(yearcase == 2  ) x2=170.00;
  ...
  //(yearcase == 1
  Float_t y1=0.85; Float_t y2=  1.1; //  for 1,2,5,6   for 11,12,15,16
  if(yearcase == 2 ) {
    y1=0.60;
    y2=  1.4;
  }
...
//      if(verbosity == 4 ){
	...
	for (int jjj=0;jjj<cx;jjj++) {
	  ...
	  if( BADruns->GetBinContent(jjj) >0.) cout<<"BADruns:   k1(0,...)= " <<      jjj      <<"  BADruns->GetBinContent(jjj)= " <<      BADruns->GetBinContent(jjj)      <<endl;
	}//jjj
//      }// if(verbosity == 2 )
    }//Method = 5
