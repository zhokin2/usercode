...
//	TFile *hfile1= new TFile("test203056.root", "READ");        
	...
	//    getchar();
	//
          TPostScript psfile ("zcalibADC.ps", 111);
//
   ...
   c1 = new TCanvas("c1","Hcal4test",200,10,700,900);
	...
	Cefz225->Sumw2();
      ...
      c1->cd(2);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_ADCCalib_HB");
      gPad->SetLogy();
      gPad->SetLogx();
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 50. )  Diffe_HB->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_HB->SetZTitle("<ADCCalib> smaller 50. HB \b");
      ...
      c1->cd(4);
      TH1F* diffAmplitude_HB = new TH1F("diffAmplitude_HB","", 100, 0., 4500.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
	...
	Cefz225->Sumw2();
      ...
      c1->cd(2);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_ADCCalib_HE");
      gPad->SetLogy();
      gPad->SetLogx();
      aaaaaa1->SetMarkerStyle(20);
      aaaaaa1->SetMarkerSize(0.8);
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 50. )  Diffe_HE->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_HE->SetZTitle("<ADCCalib> smaller 50. HE \b");
      ...
      c1->cd(4);
      TH1F* diffAmplitude_HE = new TH1F("diffAmplitude_HE","", 100, 0., 4500.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
	...
	Cefz225->Sumw2();
      ...
      c1->cd(2);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_ADCCalib_HO");
      gPad->SetLogy();
      gPad->SetLogx();
      aaaaaa1->SetMarkerStyle(20);
      aaaaaa1->SetMarkerSize(0.8);
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 50.)  Diffe_HO->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_HO->SetZTitle("<ADCCalib> smaller 50. HO \b");
      ...
      c1->cd(4);
      TH1F* diffAmplitude_HO = new TH1F("diffAmplitude_HO","", 100, 0., 7000.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
	...
	Cefz225->Sumw2();
      ...
      c1->cd(2);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_ADCCalib_HF");
      gPad->SetLogy();
      gPad->SetLogx();
      aaaaaa1->SetMarkerStyle(20);
      aaaaaa1->SetMarkerSize(0.8);
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1 < 50.)  Diffe_HF->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_HF->SetZTitle("<ADCCalib> smaller 50. HF \b");
      ...
      c1->cd(4);
      TH1F* diffAmplitude_HF = new TH1F("diffAmplitude_HF","", 100, 0., 1000.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
