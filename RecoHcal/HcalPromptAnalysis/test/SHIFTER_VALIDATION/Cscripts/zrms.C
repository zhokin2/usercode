...
//	TFile *hfile1= new TFile("Global_test.root", "READ");
        TFile *hfile1= new TFile("run_271465.root", "READ");
//        TFile *hfile1= new TFile("run_272581.root", "READ"); 
...
//
   ...
   c1 = new TCanvas("c1","Hcal4test",200,10,700,900);
	...
	Cefz225->Sumw2();
      ...
      Cefz225->SetZTitle("Rate for RMS in each event & cell > 2.25 - HB Depth1 \b");
      Cefz225->SetMarkerColor(2);
      Cefz225->SetLineColor(2);
      Cefz225->SetMaximum(1.000);
      Cefz225->SetMinimum(0.00005);
      Cefz225->Draw("COLZ");
      ...
      aaaaaa1->SetXTitle("RMS in each event & cell HB \b");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  //	  if( ccc1 > 5. ) cout<<" i = "<<i<<" j = "<<j<<"  BinContent= "<<ccc1<<endl;
	  Diffe_Depth1_HB->SetBinContent(i,j,0.);
	  //	  if(ccc1 < 2.5 || ccc1 > 3.5 )  Diffe_Depth1_HB->SetBinContent(i,j,1.);
	  //	  if(ccc1 < 1.5 || ccc1 > 1.75)  Diffe_Depth1_HB->SetBinContent(i,j,ccc1);
      ...
      //    Diffe_Depth1_HB->SetZTitle("<RMS> out 1.0-2.3 - HB Depth1 \b");
      Diffe_Depth1_HB->SetMarkerColor(2);
      Diffe_Depth1_HB->SetLineColor(2);
      Diffe_Depth1_HB->SetMinimum(0.6);
      Diffe_Depth1_HB->Draw("COLZ");
      

      c1->cd(4);
      TH1F* diffAmplitude_Depth1_HB = new TH1F("diffAmplitude_Depth1_HB","", 100, 0., 10.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
      ...
      diffAmplitude_Depth1_HB->SetXTitle("<RMS> in each cell \b");
	...
	Cefz225->Sumw2();
      ...
      Cefz225->SetXTitle("#eta \b");
      Cefz225->SetYTitle("#phi \b");
      Cefz225->SetZTitle("Rate for RMS in each event & cell > 2.25 - HB Depth2 \b");
      Cefz225->SetMarkerColor(2);
      Cefz225->SetLineColor(2);
      Cefz225->SetMaximum(1.000);
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  //	  if(ccc1 < 2.5 || ccc1 > 3.5 )  Diffe_Depth2_HB->SetBinContent(i,j,ccc1);
 	  if(ccc1 >0.)  Diffe_Depth2_HB->SetBinContent(i,j,ccc1);
     }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      //    Diffe_Depth2_HB->SetZTitle("<RMS> out 1.0-2.3 - HB Depth2 \b");
      Diffe_Depth2_HB->SetMarkerColor(2);
      Diffe_Depth2_HB->SetLineColor(2);
      Diffe_Depth2_HB->SetMinimum(0.6);
      Diffe_Depth2_HB->Draw("COLZ");
      

      c1->cd(4);
      TH1F* diffAmplitude_Depth2_HB = new TH1F("diffAmplitude_Depth2_HB","", 100, 0.,10.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
      ...
      diffAmplitude_Depth2_HB->SetXTitle("<RMS> in each cell \b");
	...
	Cefz225->Sumw2();
      ...
      Cefz225->SetXTitle("#eta \b");
      Cefz225->SetYTitle("#phi \b");
      Cefz225->SetZTitle("Rate for RMS in each event & cell > 2.25 - HE Depth1 \b");
      Cefz225->SetMarkerColor(2);
      Cefz225->SetLineColor(2);
      Cefz225->SetMaximum(1.000);
      Cefz225->SetMinimum(0.0001);
      ...
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("RMS in each event & cell HE \b");
      aaaaaa1->SetMarkerColor(2);
      aaaaaa1->SetLineColor(2);
      aaaaaa1->Draw("");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  //	  if(ccc1 < 2.5 || ccc1 > 3.5 )  Diffe_Depth1_HE->SetBinContent(i,j,ccc1);
      ...
      //    Diffe_Depth1_HE->SetZTitle("<RMS> out 1.0-2.3 - HE Depth1 \b");
      Diffe_Depth1_HE->SetMarkerColor(2);
      Diffe_Depth1_HE->SetLineColor(2);
      Diffe_Depth1_HE->SetMinimum(0.6);
      Diffe_Depth1_HE->Draw("COLZ");
      

      c1->cd(4);
      TH1F* diffAmplitude_Depth1_HE = new TH1F("diffAmplitude_Depth1_HE","", 100, 0.,10.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
      ...
      diffAmplitude_Depth1_HE->SetXTitle("<RMS> in each cell \b");
	...
	Cefz225->Sumw2();
      ...
      Cefz225->SetXTitle("#eta \b");
      Cefz225->SetYTitle("#phi \b");
      Cefz225->SetZTitle("Rate for RMS in each event & cell > 2.25 - HE Depth2 \b");
      Cefz225->SetMarkerColor(2);
      Cefz225->SetLineColor(2);
      Cefz225->SetMaximum(1.000);
      Cefz225->SetMinimum(0.0001);
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  //	  if(ccc1 < 2.5 || ccc1 > 3.5 )  Diffe_Depth2_HE->SetBinContent(i,j,ccc1);
	  if(ccc1 >0.)  Diffe_Depth2_HE->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      //    Diffe_Depth2_HE->SetZTitle("<RMS> out 1.0-2.3 - HE Depth2 \b");
      Diffe_Depth2_HE->SetMarkerColor(2);
      Diffe_Depth2_HE->SetLineColor(2);
      Diffe_Depth2_HE->SetMinimum(0.6);
      Diffe_Depth2_HE->Draw("COLZ");
      

      c1->cd(4);
      TH1F* diffAmplitude_Depth2_HE = new TH1F("diffAmplitude_Depth2_HE","", 100, 0.,10.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
      ...
      diffAmplitude_Depth2_HE->SetXTitle("<RMS> in each cell \b");
	...
	Cefz225->Sumw2();
      ...
      Cefz225->SetXTitle("#eta \b");
      Cefz225->SetYTitle("#phi \b");
      Cefz225->SetZTitle("Rate for RMS in each event & cell > 2.25 - HE Depth3 \b");
      Cefz225->SetMarkerColor(2);
      Cefz225->SetLineColor(2);
      Cefz225->SetMaximum(1.000);
      Cefz225->SetMinimum(0.0001);
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  //	  if(ccc1 < 2.5 || ccc1 > 3.5 )  Diffe_Depth3_HE->SetBinContent(i,j,ccc1);
	  if(ccc1 >0.)  Diffe_Depth3_HE->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      //    Diffe_Depth3_HE->SetZTitle("<RMS> out 1.0-2.3 - HE Depth3 \b");
      Diffe_Depth3_HE->SetMarkerColor(2);
      Diffe_Depth3_HE->SetLineColor(2);
      Diffe_Depth3_HE->SetMinimum(0.6);
      Diffe_Depth3_HE->Draw("COLZ");
      

      c1->cd(4);
      TH1F* diffAmplitude_Depth3_HE = new TH1F("diffAmplitude_Depth3_HE","", 100, 0.,10.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
      ...
      diffAmplitude_Depth3_HE->SetXTitle("<RMS> in each cell \b");
	...
	Cefz225->Sumw2();
      ...
      Cefz225->SetXTitle("#eta \b");
      Cefz225->SetYTitle("#phi \b");
      Cefz225->SetZTitle("Rate for RMS in each event & cell > 2.25 - HF Depth1 \b");
      Cefz225->SetMarkerColor(2);
      Cefz225->SetLineColor(2);
      Cefz225->SetMaximum(1.000);
      Cefz225->SetMinimum(0.0001);
      ...
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("RMS in each event & cell HF \b");
      aaaaaa1->SetMarkerColor(2);
      aaaaaa1->SetLineColor(2);
      aaaaaa1->Draw("");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  //	  if(ccc1 < 2.5 || ccc1 > 3.5 )  Diffe_Depth1_HF->SetBinContent(i,j,ccc1);
	  //	  if(ccc1 < 2.5 || ccc1 > 3.5 )  Diffe_Depth1_HF->SetBinContent(i,j,ccc1);
	  //	  if(              ccc1 > 0.0 )  Diffe_Depth1_HF->SetBinContent(i,j,ccc1);
	  if(              ccc1 > 0.0 )  Diffe_Depth1_HF->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      ...
      //    Diffe_Depth1_HF->SetZTitle("<RMS> out 0.5-2.0 - HF Depth1 \b");
      Diffe_Depth1_HF->SetMarkerColor(2);
      Diffe_Depth1_HF->SetLineColor(2);
      //    Diffe_Depth1_HF->SetMaximum(6.00);
      Diffe_Depth1_HF->SetMinimum(0.6);
      Diffe_Depth1_HF->Draw("COLZ");
      

      c1->cd(4);
      TH1F* diffAmplitude_Depth1_HF = new TH1F("diffAmplitude_Depth1_HF","", 100, 0., 4.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
      ...
      diffAmplitude_Depth1_HF->SetXTitle("<eventRMS> for HF channels \b");
	...
	Cefz225->Sumw2();
      ...
      Cefz225->SetXTitle("#eta \b");
      Cefz225->SetYTitle("#phi \b");
      Cefz225->SetZTitle("Rate for RMS in each event & cell > 2.25 - HF Depth2 \b");
      Cefz225->SetMarkerColor(2);
      Cefz225->SetLineColor(2);
      Cefz225->SetMaximum(1.000);
      Cefz225->SetMinimum(0.0001);
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  if(              ccc1 > 0.0 )  Diffe_Depth2_HF->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth2_HF->SetZTitle("<RMS> out 0.5-2.0 - HF Depth2 \b");
      Diffe_Depth2_HF->SetMarkerColor(2);
      Diffe_Depth2_HF->SetLineColor(2);
      Diffe_Depth2_HF->SetMinimum(0.6);
      Diffe_Depth2_HF->Draw("COLZ");
      

      c1->cd(4);
      TH1F* diffAmplitude_Depth2_HF = new TH1F("diffAmplitude_Depth2_HF","", 100, 0., 4.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
      ...
      diffAmplitude_Depth2_HF->SetXTitle("<RMS> in each cell \b");
	...
	Cefz225->Sumw2();
      ...
      Cefz225->SetXTitle("#eta \b");
      Cefz225->SetYTitle("#phi \b");
      Cefz225->SetZTitle("Rate for RMS in each event & cell > 2.25 - HO Depth4 \b");
      Cefz225->SetMarkerColor(2);
      Cefz225->SetLineColor(2);
      Cefz225->SetMaximum(1.000);
      ...
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("RMS in each event & cell HO \b");
      aaaaaa1->SetMarkerColor(2);
      aaaaaa1->SetLineColor(2);
      aaaaaa1->Draw("");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  //	  if(ccc1 < 2.5 || ccc1 > 3.5 )  Diffe_Depth4_HO->SetBinContent(i,j,ccc1);
	  if(              ccc1 > 0.0 )  Diffe_Depth4_HO->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      //    Diffe_Depth4_HO->SetZTitle("<RMS> out 1.0-2.5 - HO Depth4 \b");
      Diffe_Depth4_HO->SetMarkerColor(2);
      Diffe_Depth4_HO->SetLineColor(2);
      Diffe_Depth4_HO->SetMinimum(0.6);
      Diffe_Depth4_HO->Draw("COLZ");
      

      c1->cd(4);
      TH1F* diffAmplitude_Depth4_HO = new TH1F("diffAmplitude_Depth4_HO","", 100, 0.,10.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
      ...
      diffAmplitude_Depth4_HO->SetXTitle("<RMS> in each cell \b");
    ...
    for (int i=1;i<=nx;i++) {
      ...
      Diffe_Depth1_HF->SetXTitle("#eta \b");
      Diffe_Depth1_HF->SetYTitle("#phi \b");
      Diffe_Depth1_HF->SetZTitle("2D<RMS> for <RMS bigger 0 - HFDepth1 \b");
      Diffe_Depth1_HF->SetMarkerColor(2);
      Diffe_Depth1_HF->SetLineColor(2);
      //    Diffe_Depth1_HF->SetMaximum(6.00);
      Diffe_Depth1_HF->SetMinimum(0.6);
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  //	  if(ccc1 < 2.5 || ccc1 > 3.5 )  Diffe_Depth1_HF->SetBinContent(i,j,ccc1);
	  //	  if(              ccc1 > 0.0 )  Diffe_Depth1_HF->SetBinContent(i,j,ccc1);
	  if(              ccc1 > 1.0 )  Diffe_Depth1_HF->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth1_HF->SetYTitle("#phi \b");
      //    Diffe_Depth1_HF->SetZTitle("<RMS> out 0.5-2.0 - HF Depth1 \b");
      Diffe_Depth1_HF->SetZTitle("2D<RMS> for <RMS bigger 1 - HFDepth1 \b");
      Diffe_Depth1_HF->SetMarkerColor(2);
      Diffe_Depth1_HF->SetLineColor(2);
      //    Diffe_Depth1_HF->SetMaximum(6.00);
      Diffe_Depth1_HF->SetMinimum(0.6);
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  //	  if(ccc1 < 2.5 || ccc1 > 3.5 )  Diffe_Depth1_HF->SetBinContent(i,j,ccc1);
	  //	  if(              ccc1 > 0.0 )  Diffe_Depth1_HF->SetBinContent(i,j,ccc1);
	  if(              ccc1 > 1.5 )  Diffe_Depth1_HF->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth1_HF->SetYTitle("#phi \b");
      //    Diffe_Depth1_HF->SetZTitle("<RMS> out 0.5-2.0 - HF Depth1 \b");
      Diffe_Depth1_HF->SetZTitle("2D<RMS> for <RMS bigger 1.5 - HFDepth1 \b");
      Diffe_Depth1_HF->SetMarkerColor(2);
      Diffe_Depth1_HF->SetLineColor(2);
      //    Diffe_Depth1_HF->SetMaximum(6.00);
      Diffe_Depth1_HF->SetMinimum(0.6);
      ...
      c1->cd(4);
      TH1F* diffAmplitude_Depth1_HF0 = new TH1F("diffAmplitude_Depth1_HF0","", 100, 0., 4.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
	  if(Ceff->GetBinContent(i,j) !=0 ) {
	    double ccc1 =  Ceff->GetBinContent(i,j) ;
	    diffAmplitude_Depth1_HF0->Fill(ccc1);
	  }
	}
      }
      gPad->SetLogy();
      diffAmplitude_Depth1_HF0->SetMarkerStyle(20);
      diffAmplitude_Depth1_HF0->SetMarkerSize(0.4);
      diffAmplitude_Depth1_HF0->GetYaxis()->SetLabelSize(0.04);
      diffAmplitude_Depth1_HF0->SetXTitle("<eventRMS> for HFDepth1 channels \b");
      diffAmplitude_Depth1_HF0->SetMarkerColor(2);
      diffAmplitude_Depth1_HF0->SetLineColor(2);
      diffAmplitude_Depth1_HF0->Draw("");
	...
	Ceff->Sumw2();
      ...
      c1->cd(1);
    ///////////////////////////////////////
    TH2F* Diffe_Depth2_HF = (TH2F*)Ceff->Clone("Diffe_Depth2_HFDepth2");
    int nx = Ceff->GetXaxis()->GetNbins();
    int ny = Ceff->GetYaxis()->GetNbins();
    for (int i=1;i<=nx;i++) {
      for (int j=1;j<=ny;j++) {
	  double ccc1 =  Ceff->GetBinContent(i,j)   ;
	  Diffe_Depth2_HF->SetBinContent(i,j,0.);
	  //	  if(ccc1 < 2.5 || ccc1 > 3.5 )  Diffe_Depth2_HF->SetBinContent(i,j,ccc1);
	  //	  if(ccc1 < 2.5 || ccc1 > 3.5 )  Diffe_Depth2_HF->SetBinContent(i,j,ccc1);
	  //	  if(              ccc1 > 0.0 )  Diffe_Depth2_HF->SetBinContent(i,j,ccc1);
	  if(              ccc1 > 0.0 )  Diffe_Depth2_HF->SetBinContent(i,j,ccc1);
      }
      ...
      Diffe_Depth2_HF->SetXTitle("#eta \b");
      Diffe_Depth2_HF->SetYTitle("#phi \b");
      Diffe_Depth2_HF->SetZTitle("2D<RMS> for <RMS bigger 0 - HFDepth2 \b");
      Diffe_Depth2_HF->SetMarkerColor(2);
      Diffe_Depth2_HF->SetLineColor(2);
      //    Diffe_Depth2_HF->SetMaximum(6.00);
      Diffe_Depth2_HF->SetMinimum(0.6);
      Diffe_Depth2_HF->Draw("COLZ");
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  //	  if(ccc1 < 2.5 || ccc1 > 3.5 )  Diffe_Depth2_HF->SetBinContent(i,j,ccc1);
	  //	  if(              ccc1 > 0.0 )  Diffe_Depth2_HF->SetBinContent(i,j,ccc1);
	  if(              ccc1 > 1.0 )  Diffe_Depth2_HF->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth2_HF->SetYTitle("#phi \b");
      //    Diffe_Depth2_HF->SetZTitle("<RMS> out 0.5-2.0 - HF Depth2 \b");
      Diffe_Depth2_HF->SetZTitle("2D<RMS> for <RMS bigger 1 - HFDepth2 \b");
      Diffe_Depth2_HF->SetMarkerColor(2);
      Diffe_Depth2_HF->SetLineColor(2);
      //    Diffe_Depth2_HF->SetMaximum(6.00);
      Diffe_Depth2_HF->SetMinimum(0.6);
    ...
    for (int i=1;i<=nx;i++) {
	  ...
	  //	  if(ccc1 < 2.5 || ccc1 > 3.5 )  Diffe_Depth2_HF->SetBinContent(i,j,ccc1);
	  //	  if(              ccc1 > 0.0 )  Diffe_Depth2_HF->SetBinContent(i,j,ccc1);
	  if(              ccc1 > 1.5 )  Diffe_Depth2_HF->SetBinContent(i,j,ccc1);
      }
    }
      gPad->SetGridy();
      gPad->SetGridx();
      ...
      Diffe_Depth2_HF->SetYTitle("#phi \b");
      //    Diffe_Depth2_HF->SetZTitle("<RMS> out 0.5-2.0 - HF Depth2 \b");
      Diffe_Depth2_HF->SetZTitle("2D<RMS> for <RMS bigger 1.5 - HF \b");
      Diffe_Depth2_HF->SetMarkerColor(2);
      Diffe_Depth2_HF->SetLineColor(2);
      //    Diffe_Depth2_HF->SetMaximum(6.00);
      Diffe_Depth2_HF->SetMinimum(0.6);
      ...
      c1->cd(4);
      TH1F* diffAmplitude_Depth2_HF0 = new TH1F("diffAmplitude_Depth2_HF0","", 100, 0., 4.);
      int nx = Ceff->GetXaxis()->GetNbins();
      int ny = Ceff->GetYaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	for (int j=1;j<=ny;j++) {
	  if(Ceff->GetBinContent(i,j) !=0 ) {
	    double ccc1 =  Ceff->GetBinContent(i,j) ;
	    diffAmplitude_Depth2_HF0->Fill(ccc1);
	  }
	}
      }
      gPad->SetLogy();
      diffAmplitude_Depth2_HF0->SetMarkerStyle(20);
      diffAmplitude_Depth2_HF0->SetMarkerSize(0.4);
      diffAmplitude_Depth2_HF0->GetYaxis()->SetLabelSize(0.04);
      diffAmplitude_Depth2_HF0->SetXTitle("<eventRMS> for HFDepth2 channels \b");
      diffAmplitude_Depth2_HF0->SetMarkerColor(2);
      diffAmplitude_Depth2_HF0->SetLineColor(2);
      diffAmplitude_Depth2_HF0->Draw("");
