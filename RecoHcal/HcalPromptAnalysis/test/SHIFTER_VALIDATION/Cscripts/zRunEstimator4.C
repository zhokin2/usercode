...
//	TFile *hfile1= new TFile("testNZS.root", "READ"); 
	...
	//    getchar();
	//
          TPostScript psfile ("zRunEstimator4.ps", 111);
//
   ...
   c1 = new TCanvas("c1","Hcal4test",200,10,700,900);
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_sumAmplitudeLS1");
      gPad->SetLogy();
      ...
      c1->cd(2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_2DsumAmplitudeLS1");
      TH2F *twod0= (TH2F*)hfile1->Get("h_2D0sumAmplitudeLS1");
      twod1->Sumw2();
      twod0->Sumw2();
...
//            Cefz1->SetMinimum(1.0);
	...
	Rate1->Sumw2();
      ...
      //    Rate1->SetMaximum(1.65);
      //    Rate1->SetMinimum(1.55);
      Rate1->Draw("Error");
      int nx = Rate1->GetXaxis()->GetNbins();
      cout<<"1 Max # iLS = "<< nx <<endl;
      for (int i=1;i<=nx;i++) {
	double ccc1 =  Rate1->GetBinContent(i)   ;
	if(ccc1>4) cout<<" iLS =     "<< i <<"    1<A> per channel= "<<ccc1<<endl;
	if(ccc1<0.1) cout<<" iLS =     "<< i <<"    1<A> per channel= "<<ccc1<<endl;
	//	if(i == 735) cout<<"Red Dots,  iLS =     "<< i <<"    1<A> per channel= "<<ccc1<<endl;
      }
      TH1F *aaa2 = (TH1F*)hfile1->Get("h_sumCutAmplitudeperLS1");
      TH1F *aaaa1= (TH1F*)hfile1->Get("h_sum0AmplitudeperLS1");
      aaa2->Sumw2();
      aaaa1->Sumw2();
      if(aaaa1->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate1 = (TH1F*)aaa2->Clone("Rate1");
	Rate1->Divide(aaa2,aaaa1, 1, 1, "B");
	Rate1->Sumw2();
      }
      Rate1->SetMarkerStyle(20);
      Rate1->SetMarkerSize(0.8);
...
//      TH1F* ADCAmplperLS = new TH1F("ADCAmplperLS","", maxbins, 1., maxbins+1.);
	...
	//	  if(ccc1>0.)	  cout<<" depth1_HB iLS = "<<i<<" <As> per LS= "<<ccc1<<endl;
      ...
      ADCAmplperLS ->SetMaximum(2.85);
      ADCAmplperLS ->SetMinimum(2.75);
	...
	Rate1->Sumw2();
      ...
      Rate1->SetMarkerColor(2);
      Rate1->SetLineColor(0);
      //        Rate1->SetMaximum(2.890);
      //        Rate1->SetMinimum(2.83);
      //    Rate1->SetMaximum(8.);
      //    Rate1->SetMinimum(0.);
      Rate1->Draw("Error");
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumAmplitudeperLS1_LSselected");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0AmplitudeperLS1");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	...
	Rate1->Sumw2();
      ...
      Rate1->SetLineColor(0);
      //        Rate1->SetMaximum(2.880);
      //        Rate1->SetMinimum(2.84);
//      Rate1->SetMaximum(8.);
//      Rate1->SetMinimum(0.);
    Rate1->Draw("ErrorSame");
      */
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa2= (TH1F*)hfile1->Get("h_sumAmplitudeLS2");
      gPad->SetLogy();
      ...
      c1->cd(2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_2DsumAmplitudeLS2");
      TH2F *twod0= (TH2F*)hfile1->Get("h_2D0sumAmplitudeLS2");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz2->Sumw2();
      ...
      c1->cd(3);
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumAmplitudeperLS2");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0AmplitudeperLS2");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	...
	Rate2->Sumw2();
      ...
      Rate2->Draw("Error");
      TH1F *aaa2 = (TH1F*)hfile1->Get("h_sumCutAmplitudeperLS2");
      TH1F *aaaa1= (TH1F*)hfile1->Get("h_sum0AmplitudeperLS2");
      aaa2->Sumw2();
      aaaa1->Sumw2();
      if(aaaa1->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate2 = (TH1F*)aaa2->Clone("Rate2");
	Rate2->Divide(aaa2,aaaa1, 1, 1, "B");
	Rate2->Sumw2();
      }
      Rate2->SetMarkerStyle(20);
      Rate2->SetMarkerSize(0.8);
	...
	Rate1->Sumw2();
      ...
      //    Rate1->SetMaximum(2.890);
      //    Rate1->SetMinimum(2.83);
      //    Rate1->SetMaximum(3.000);
      //    Rate1->SetMinimum(2.7);
      Rate1->Draw("Error");
      c1->Update();
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa3= (TH1F*)hfile1->Get("h_sumAmplitudeLS3");
      gPad->SetLogy();
      ...
      c1->cd(2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_2DsumAmplitudeLS3");
      TH2F *twod0= (TH2F*)hfile1->Get("h_2D0sumAmplitudeLS3");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz3->Sumw2();
      ...
      c1->cd(3);
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumAmplitudeperLS3");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0AmplitudeperLS3");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate1 = (TH1F*)twod3->Clone("Rate1");
	...
	Rate1->Sumw2();
      ...
      Rate1->SetMarkerColor(2);
      Rate1->SetLineColor(0);
      //      Rate1->SetMaximum(1.80);
//      Rate1->SetMinimum(1.65);
      Rate1->Draw("Error");
      TH1F *aaa2 = (TH1F*)hfile1->Get("h_sumCutAmplitudeperLS3");
      TH1F *aaaa1= (TH1F*)hfile1->Get("h_sum0AmplitudeperLS3");
      aaa2->Sumw2();
      aaaa1->Sumw2();
      if(aaaa1->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate1 = (TH1F*)aaa2->Clone("Rate1");
	...
	Rate1->Sumw2();
      ...
      Rate1->SetMarkerColor(2);
      Rate1->SetLineColor(0);
      //    Rate1->SetMaximum(2.870);
      //    Rate1->SetMinimum(2.80);
      //    Rate1->SetMaximum(3.000);
      //    Rate1->SetMinimum(2.7);
      Rate1->Draw("Error");
      c1->Update();
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa4= (TH1F*)hfile1->Get("h_sumAmplitudeLS4");
      gPad->SetLogy();
      ...
      c1->cd(2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_2DsumAmplitudeLS4");
      TH2F *twod0= (TH2F*)hfile1->Get("h_2D0sumAmplitudeLS4");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz4->Sumw2();
      ...
      c1->cd(3);
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumAmplitudeperLS4");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0AmplitudeperLS4");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate2 = (TH1F*)twod3->Clone("Rate2");
	...
	Rate2->Sumw2();
      ...
      Rate2->SetLineColor(0);
      Rate2->Draw("Error");
      TH1F *aaa2 = (TH1F*)hfile1->Get("h_sumCutAmplitudeperLS4");
      TH1F *aaaa1= (TH1F*)hfile1->Get("h_sum0AmplitudeperLS4");
      aaa2->Sumw2();
      aaaa1->Sumw2();
      if(aaaa1->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate2 = (TH1F*)aaa2->Clone("Rate2");
	...
	Rate1->Sumw2();
      ...
      Rate1->SetMarkerColor(2);
      Rate1->SetLineColor(0);
      //    Rate1->SetMaximum(2.900);
      //    Rate1->SetMinimum(2.8);
      //    Rate1->SetMaximum(3.000);
      //    Rate1->SetMinimum(2.7);
      Rate1->Draw("Error");
      c1->Update();
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa5= (TH1F*)hfile1->Get("h_sumAmplitudeLS5");
      gPad->SetLogy();
      ...
      c1->cd(2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_2DsumAmplitudeLS5");
      TH2F *twod0= (TH2F*)hfile1->Get("h_2D0sumAmplitudeLS5");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz5->Sumw2();
      ...
      c1->cd(3);
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumAmplitudeperLS5");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0AmplitudeperLS5");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate2 = (TH1F*)twod3->Clone("Rate2");
	...
	Rate2->Sumw2();
      ...
      Rate2->SetLineColor(0);
      Rate2->Draw("Error");
      TH1F *aaa2 = (TH1F*)hfile1->Get("h_sumCutAmplitudeperLS5");
      TH1F *aaaa1= (TH1F*)hfile1->Get("h_sum0AmplitudeperLS5");
      aaa2->Sumw2();
      aaaa1->Sumw2();
      if(aaaa1->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate2 = (TH1F*)aaa2->Clone("Rate2");
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa6= (TH1F*)hfile1->Get("h_sumAmplitudeLS6");
      gPad->SetLogy();
      ...
      c1->cd(2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_2DsumAmplitudeLS6");
      TH2F *twod0= (TH2F*)hfile1->Get("h_2D0sumAmplitudeLS6");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz6->Sumw2();
      ...
      c1->cd(3);
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumAmplitudeperLS6");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0AmplitudeperLS6");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate2 = (TH1F*)twod3->Clone("Rate2");
	...
	Rate2->Sumw2();
      ...
      Rate2->SetMarkerColor(2);
      Rate2->SetLineColor(0);
      Rate2->SetMaximum(1.20);
      Rate2->SetMinimum(0.80);
      Rate2->Draw("Error");
      TH1F *twod9= (TH1F*)hfile1->Get("h_sumCutAmplitudeperLS6");
      TH1F *twod8= (TH1F*)hfile1->Get("h_sum0AmplitudeperLS6");
      twod9->Sumw2();
      twod8->Sumw2();
      if(twod8->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate3 = (TH1F*)twod9->Clone("Rate3");
	Rate3->Divide(twod9,twod8, 1, 1, "B");
	Rate3->Sumw2();
      }
      Rate3->SetMarkerStyle(20);
      Rate3->SetMarkerSize(0.8);
      Rate3->SetXTitle("<A>(ev.in LS & ch.) - HF depth1 -    iLS \b");
      Rate3->SetMarkerColor(1);
      Rate3->SetLineColor(0);
      //    Rate3->Draw("ErrorSame");
      int nx = Rate3->GetXaxis()->GetNbins();
      cout<<"6 Max # iLS = "<< nx <<endl;
      for (int i=1;i<=nx;i++) {
	double ccc1 =  Rate3->GetBinContent(i)   ;
	if(ccc1>1) cout<<" iLS =     "<< i <<"    6<A> per channel= "<<ccc1<<endl;
      }

      c1->cd(4);
      TH1F* ADCAmplperLS  = new TH1F("ADCAmplperLS ","", 425, 0.,425.);
      int nx = Rate2->GetXaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	double ccc1 =  Rate2->GetBinContent(i);
	//	  if(ccc1>0.)	  cout<<" depth1_HB iLS = "<<i<<" <As> per LS= "<<ccc1<<endl;
      ...
      ADCAmplperLS ->SetMarkerSize(0.4);
      ADCAmplperLS ->GetYaxis()->SetLabelSize(0.04);
      ADCAmplperLS ->SetXTitle("<RMS> per LS HF1 \b");
      ADCAmplperLS ->SetMarkerColor(2);
      ADCAmplperLS ->SetLineColor(0);
      ADCAmplperLS ->SetMaximum(1.02);
      ADCAmplperLS ->SetMinimum(0.98);
      ADCAmplperLS ->Draw("Error");
	...
	Rate1->Sumw2();
      ...
      Rate1->SetMarkerColor(2);
      Rate1->SetLineColor(0);
      //    Rate1->SetMaximum(1.100);
      //    Rate1->SetMinimum(0.2);
      Rate1->Draw("Error");
...
*/
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa7= (TH1F*)hfile1->Get("h_sumAmplitudeLS7");
      gPad->SetLogy();
      ...
      c1->cd(2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_2DsumAmplitudeLS7");
      TH2F *twod0= (TH2F*)hfile1->Get("h_2D0sumAmplitudeLS7");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz7->Sumw2();
      ...
      c1->cd(3);
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumAmplitudeperLS7");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0AmplitudeperLS7");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate2 = (TH1F*)twod3->Clone("Rate2");
	...
	Rate2->Sumw2();
      ...
      Rate2->SetLineColor(0);
      Rate2->Draw("Error");
      TH1F *aaa2 = (TH1F*)hfile1->Get("h_sumCutAmplitudeperLS7");
      TH1F *aaaa1= (TH1F*)hfile1->Get("h_sum0AmplitudeperLS7");
      twod3->Sumw2();
      aaaa1->Sumw2();
      if(aaaa1->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate3 = (TH1F*)twod3->Clone("Rate3");
	Rate3->Divide(twod3,aaaa1, 1, 1, "B");
	Rate3->Sumw2();
      }
      Rate3->SetMarkerStyle(20);
      Rate3->SetMarkerSize(0.8);
      Rate3->SetXTitle("<A>(ev.in LS & ch.) - HF depth2 -    iLS \b");
      Rate3->SetMarkerColor(1);
      Rate3->SetLineColor(0);
      Rate3->Draw("ErrorSame");
      int nx = Rate3->GetXaxis()->GetNbins();
	...
	if(ccc1>9) cout<<" iLS =     "<< i <<"    7<A> per channel= "<<ccc1<<endl;
      ...
      c1->cd(4);
     TH1F* ADCAmplperLS  = new TH1F("ADCAmplperLS ","", 125, 0.,125.);
      int nx = Rate2->GetXaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	double ccc1 =  Rate2->GetBinContent(i);
	//	  if(ccc1>0.)	  cout<<" depth1_HB iLS = "<<i<<" <As> per LS= "<<ccc1<<endl;
      ...
      ADCAmplperLS ->SetMarkerSize(0.4);
      ADCAmplperLS ->GetYaxis()->SetLabelSize(0.04);
      ADCAmplperLS ->SetXTitle("<RMS> per LS HF2 \b");
      ADCAmplperLS ->SetMarkerColor(2);
      ADCAmplperLS ->SetLineColor(0);
      ADCAmplperLS ->SetMaximum(1.16);
      ADCAmplperLS ->SetMinimum(1.12);
      ADCAmplperLS ->Draw("Error");
      /*
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumAmplitudeperLS7");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0AmplitudeperLS7");
...
*/
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa8= (TH1F*)hfile1->Get("h_sumAmplitudeLS8");
      gPad->SetLogy();
      ...
      c1->cd(2);
      TH2F *twod1= (TH2F*)hfile1->Get("h_2DsumAmplitudeLS8");
      TH2F *twod0= (TH2F*)hfile1->Get("h_2D0sumAmplitudeLS8");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH2F")){
	...
	Cefz8->Sumw2();
      ...
      c1->cd(3);
      TH1F *twod3= (TH1F*)hfile1->Get("h_sumAmplitudeperLS8");
      TH1F *twod2= (TH1F*)hfile1->Get("h_sum0AmplitudeperLS8");
      twod3->Sumw2();
      twod2->Sumw2();
      if(twod2->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate2 = (TH1F*)twod3->Clone("Rate2");
	...
	Rate2->Sumw2();
      ...
      Rate2->SetMarkerColor(2);
      Rate2->SetLineColor(0);
//      Rate2->SetMaximum(1.50);
//      Rate2->SetMinimum(1.35);
      Rate2->Draw("Error");
      TH1F *aaa2 = (TH1F*)hfile1->Get("h_sumCutAmplitudeperLS8");
      TH1F *aaaa1= (TH1F*)hfile1->Get("h_sum0AmplitudeperLS8");
      aaa2->Sumw2();
      aaaa1->Sumw2();
      if(aaaa1->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate3 = (TH1F*)aaa2->Clone("Rate3");
	Rate3->Divide(aaa2,aaaa1, 1, 1, "B");
	Rate3->Sumw2();
      }
      Rate3->SetMarkerStyle(20);
      Rate3->SetMarkerSize(0.8);
      Rate3->SetXTitle("<A>(ev.in LS & ch.) - HO depth3 -    iLS \b");
      Rate3->SetMarkerColor(1);
      Rate3->SetLineColor(0);
      //    Rate3->Draw("ErrorSame");
      int nx = Rate3->GetXaxis()->GetNbins();
