...
void zamt3_HF() {
  ...
  while (Method<NMethodsToUse+1) {
	...
	pad1->DrawFrame(1,   0.8,  370,   1.4);// all 
      }
      else if(Method== 19 || Method== 21 ){
	pad1->DrawFrame(1,   0.93,  370,   1.07);// all 
      }
      else if(Method== 20  ){
	pad1->DrawFrame(1,   0.90,  370,   1.20);// all 
      }
      else if( (Method>= 11 && Method<= 18) || (Method>= 26 && Method<= 33) ){
	pad1->DrawFrame(1,   0.99,  370,   1.01);// all 
      }
      else {
	pad1->DrawFrame(1,   0.94,  370,   1.06);// all 
      }
    }
    // absolut values:
    else {
	...
	//
	  ...
	  //
	  //
	  if(Method < 6 || Method == 34) TH2F *twod0= (TH2F*)hfile->Get("h_mapDepth1_HF");
    ...
    //  
//    TString fdir = "plots/";
//    TString fdir = "plots_HF_normalized_3etaRange/";
    TString fdir = "plots_HF_normalized/";
//    TString fdir = "plots_HF_absolut/";
//
