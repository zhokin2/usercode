...
const Int_t NMethodsStart =24;     // since which method to start ( min=  1)
...
// //    if(Method > 5 && Method < 21 ) NR = 1;// only averaged values, one dependence only
	...
	if(FlagWhatToImpose == 1 ) {pad1->DrawFrame(1,   0.0,  maxdays,   4.0);}
	  ...
	  if(YEAR == 2 ) pad1->DrawFrame(1,   0.0,  maxdays,   2.0);
	}
      }
      else if(Method== 19 || Method== 21 ){
	...
	pad1->DrawFrame(1,   0.99,  maxdays,   1.01);// all 
      ...
      if(Method ==37&&YEAR==2) pad1->DrawFrame(1,    0.,  maxdays,      5.);  //37-NbCapIdErrors 
      if(Method ==37&&YEAR<0) pad1->DrawFrame(1,    0.,  maxdays,      10.);  //37-NbCapIdErrors 
    }
    //______________________________________________________________________________
...
//    TString fdir = "plots/";
//    TString fdir = "plots_HB_normalized_3etaRange/";
//    TString fdir = "plots_HB_normalized/";
//    TString fdir = "plots_HB_absolut/";
//
