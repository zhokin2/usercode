...
//
   ...
   c1 = new TCanvas("c1","Hcal4test",200,10,700,900);
	...
	if(ccc1>0.0006) {
      ...
      TH1F *twod1= (TH1F*)hfile1->Get("h_runnbadchannelsC_depth1_HB");
      TH1F *twod0= (TH1F*)hfile1->Get("h_runbadrate0_depth1_HB");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate1C = (TH1F*)twod1->Clone("Rate1C");
	Rate1C->Divide(twod1,twod0, 1, 1, "B");
	Rate1C->Sumw2();
      }
      //    gPad->SetGridy();
      //    gPad->SetGridx();
...
//      int nx = Rate1C->GetXaxis()->GetNbins();
//      for (int i=1;i<=nx;i++) {
...
//      }
    ...
    //======================================================================
      ...
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("N bad channels - HB depth2 \b");
      aaaaaa1->SetYTitle("Nevents \b");
      aaaaaa1->SetMarkerColor(4);
      aaaaaa1->SetLineColor(4);
      aaaaaa1->SetMinimum(0.8);
//      aaaaaa1->SetMinimum(0.0001);
	...
	if(ccc1>0.15) {
      ...
      Rate2->Draw("Error");
      TH1F *twod1= (TH1F*)hfile1->Get("h_runnbadchannelsC_depth2_HB");
      TH1F *twod0= (TH1F*)hfile1->Get("h_runbadrate0_depth2_HB");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate2C = (TH1F*)twod1->Clone("Rate2C");
	Rate2C->Divide(twod1,twod0, 1, 1, "B");
	Rate2C->Sumw2();
      }
      //    gPad->SetGridy();
      //    gPad->SetGridx();
...
//      Rate2C->Draw("SameError");
	...
	//	if(Rate2->GetBinContent(i) !=0 ) {
      ...
      int nx = Rate2C->GetXaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
    ...
    //======================================================================
      ...
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("N bad channels - HE depth1 \b");
      aaaaaa1->SetYTitle("Nevents \b");
      aaaaaa1->SetMarkerColor(4);
      aaaaaa1->SetLineColor(4);
      aaaaaa1->SetMinimum(0.8);
//      aaaaaa1->SetMinimum(0.0001);
	...
	if(ccc1>0.00004) {
      ...
      TH1F *twod1= (TH1F*)hfile1->Get("h_runnbadchannelsC_depth1_HE");
      TH1F *twod0= (TH1F*)hfile1->Get("h_runbadrate0_depth1_HE");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate3C = (TH1F*)twod1->Clone("Rate3C");
	Rate3C->Divide(twod1,twod0, 1, 1, "B");
	Rate3C->Sumw2();
      }
      //    gPad->SetGridy();
      //    gPad->SetGridx();
	...
	//	if(Rate3->GetBinContent(i) !=0 ) {
      ...
      int nx = Rate3C->GetXaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
    ...
    //======================================================================
      ...
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("N bad channels - HE depth2 \b");
      aaaaaa1->SetYTitle("Nevents \b");
      aaaaaa1->SetMarkerColor(4);
      aaaaaa1->SetLineColor(4);
      aaaaaa1->SetMinimum(0.8);
//      aaaaaa1->SetMinimum(0.0001);
	...
	Rate4->Sumw2();
      ...
      Rate4->Draw("Error");
      TH1F *twod1= (TH1F*)hfile1->Get("h_runnbadchannelsC_depth2_HE");
      TH1F *twod0= (TH1F*)hfile1->Get("h_runbadrate0_depth2_HE");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate4C = (TH1F*)twod1->Clone("Rate4C");
	Rate4C->Divide(twod1,twod0, 1, 1, "B");
	Rate4C->Sumw2();
      }
      //    gPad->SetGridy();
      //    gPad->SetGridx();
      ...
      int nx = Rate4->GetXaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	//	if(Rate4->GetBinContent(i) !=0 ) {
      ...
      int nx = Rate4C->GetXaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
    ...
    //======================================================================
      ...
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("N bad channels - HE depth3 \b");
      aaaaaa1->SetYTitle("Nevents \b");
      aaaaaa1->SetMarkerColor(4);
      aaaaaa1->SetLineColor(4);
      aaaaaa1->SetMinimum(0.8);
//      aaaaaa1->SetMinimum(0.0001);
	...
	Rate5->Sumw2();
      ...
      Rate5->Draw("Error");
      TH1F *twod1= (TH1F*)hfile1->Get("h_runnbadchannelsC_depth3_HE");
      TH1F *twod0= (TH1F*)hfile1->Get("h_runbadrate0_depth3_HE");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate5C = (TH1F*)twod1->Clone("Rate5C");
	Rate5C->Divide(twod1,twod0, 1, 1, "B");
	Rate5C->Sumw2();
      }
      //    gPad->SetGridy();
      //    gPad->SetGridx();
      ...
      int nx = Rate5->GetXaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	//	if(Rate5->GetBinContent(i) !=0 ) {
      ...
      int nx = Rate5C->GetXaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_nbadchannels_depth4_HO");
      gPad->SetLogy();
      aaaaaa1->SetMarkerStyle(20);
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("N bad channels - HO depth4 \b");
      aaaaaa1->SetYTitle("Nevents \b");
      aaaaaa1->SetMarkerColor(4);
      aaaaaa1->SetLineColor(4);
      aaaaaa1->SetMinimum(0.1);
      aaaaaa1->Draw("");
...
//	Double_t ratio=0.;
//	if(aaaaaa1->GetBinContent(binx) > 0) ratio=aaaaaa1->GetBinContent(binx);
...
//      Cdef143->Draw("");
            ...
            c1->cd(2);
      TH1F *twod1= (TH1F*)hfile1->Get("h_runnbadchannels_depth4_HO");
      TH1F *twod0= (TH1F*)hfile1->Get("h_runbadrate0_depth4_HO");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate6 = (TH1F*)twod1->Clone("Rate6");
	Rate6->Divide(twod1,twod0, 1, 1, "B");
	Rate6->Sumw2();
      }
      //    gPad->SetGridy();
      //    gPad->SetGridx();
      ...
      //      Rate6->SetMaximum(100.);
            Rate6->Draw("Error");
      int nx = Rate6->GetXaxis()->GetNbins();
	...
	if(ccc1>3.0) {
      ...
      TH1F *twod1= (TH1F*)hfile1->Get("h_runnbadchannelsC_depth4_HO");
      TH1F *twod0= (TH1F*)hfile1->Get("h_runbadrate0_depth4_HO");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate6C = (TH1F*)twod1->Clone("Rate6C");
	Rate6C->Divide(twod1,twod0, 1, 1, "B");
	Rate6C->Sumw2();
      }
      //    gPad->SetGridy();
      //    gPad->SetGridx();
	...
	//	if(Rate6->GetBinContent(i) !=0 ) {
      ...
      int nx = Rate6C->GetXaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_nbadchannels_depth1_HF");
      gPad->SetLogy();
      aaaaaa1->SetMarkerStyle(20);
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("N bad channels - HF depth1 \b");
      aaaaaa1->SetYTitle("Nevents \b");
      aaaaaa1->SetMarkerColor(4);
      aaaaaa1->SetLineColor(4);
      aaaaaa1->SetMinimum(0.8);
      ...
      c1->cd(2);
      TH1F *twod1= (TH1F*)hfile1->Get("h_runnbadchannels_depth1_HF");
      TH1F *twod0= (TH1F*)hfile1->Get("h_runbadrate0_depth1_HF");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate7 = (TH1F*)twod1->Clone("Rate7");
	Rate7->Divide(twod1,twod0, 1, 1, "B");
	Rate7->Sumw2();
      }
      //    gPad->SetGridy();
      //    gPad->SetGridx();
      ...
      Rate7->Draw("Error");
      int nx = Rate7->GetXaxis()->GetNbins();
	...
	if(ccc1>0.0) {
      ...
      TH1F *twod1= (TH1F*)hfile1->Get("h_runnbadchannelsC_depth1_HF");
      TH1F *twod0= (TH1F*)hfile1->Get("h_runbadrate0_depth1_HF");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate7C = (TH1F*)twod1->Clone("Rate7C");
	Rate7C->Divide(twod1,twod0, 1, 1, "B");
	Rate7C->Sumw2();
      }
      //    gPad->SetGridy();
      //    gPad->SetGridx();
	...
	//	if(Rate7->GetBinContent(i) !=0 ) {
      ...
      int nx = Rate7C->GetXaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *aaaaaa1= (TH1F*)hfile1->Get("h_nbadchannels_depth2_HF");
      gPad->SetLogy();
      aaaaaa1->SetMarkerStyle(20);
      aaaaaa1->SetMarkerSize(0.8);
      aaaaaa1->GetYaxis()->SetLabelSize(0.04);
      aaaaaa1->SetXTitle("N bad channels - HF depth2 \b");
      aaaaaa1->SetYTitle("Nevents \b");
      aaaaaa1->SetMarkerColor(4);
      aaaaaa1->SetLineColor(4);
      aaaaaa1->SetMinimum(0.8);
      ...
      c1->cd(2);
      TH1F *twod1= (TH1F*)hfile1->Get("h_runnbadchannels_depth2_HF");
      TH1F *twod0= (TH1F*)hfile1->Get("h_runbadrate0_depth2_HF");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate8 = (TH1F*)twod1->Clone("Rate8");
	Rate8->Divide(twod1,twod0, 1, 1, "B");
	Rate8->Sumw2();
      }
      //    gPad->SetGridy();
      //    gPad->SetGridx();
	...
	if(ccc1>0.002) {
      ...
      TH1F *twod1= (TH1F*)hfile1->Get("h_runnbadchannelsC_depth2_HF");
      TH1F *twod0= (TH1F*)hfile1->Get("h_runbadrate0_depth2_HF");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate8C = (TH1F*)twod1->Clone("Rate8C");
	Rate8C->Divide(twod1,twod0, 1, 1, "B");
	Rate8C->Sumw2();
      }
      //    gPad->SetGridy();
      //    gPad->SetGridx();
      ...
      int nx = Rate8->GetXaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
	//	if(Rate8->GetBinContent(i) !=0 ) {
      ...
      int nx = Rate8C->GetXaxis()->GetNbins();
      for (int i=1;i<=nx;i++) {
    ...
    //======================================================================
      ...
      c1->cd(1);
      TH1F *twod1= (TH1F*)hfile1->Get("h_bcnnbadchannels_depth1_HB");
      TH1F *twod0= (TH1F*)hfile1->Get("h_bcnbadrate0_depth1_HB");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate1 = (TH1F*)twod1->Clone("Rate1");
	...
	Rate1->Sumw2();
      ...
      Rate1->SetMarkerStyle(20);
      Rate1->SetMarkerSize(0.8);
      Rate1->SetXTitle("< Nbcs > HB depth1                       iBCN \b");
      Rate1->SetMarkerColor(2);
      Rate1->SetLineColor(0);
      Rate1->Draw("Error");

      c1->cd(2);
      TH1F *twod1= (TH1F*)hfile1->Get("h_bcnnbadchannels_depth2_HB");
      TH1F *twod0= (TH1F*)hfile1->Get("h_bcnbadrate0_depth2_HB");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate1 = (TH1F*)twod1->Clone("Rate1");
	...
	Rate1->Sumw2();
      ...
      Rate1->SetMarkerStyle(20);
      Rate1->SetMarkerSize(0.8);
      Rate1->SetXTitle("< Nbcs > HB depth2                       iBCN \b");
      Rate1->SetMarkerColor(2);
      Rate1->SetLineColor(0);
      Rate1->Draw("Error");

      c1->cd(3);
      TH1F *twod1= (TH1F*)hfile1->Get("h_bcnnbadchannels_depth1_HE");
      TH1F *twod0= (TH1F*)hfile1->Get("h_bcnbadrate0_depth1_HE");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate1 = (TH1F*)twod1->Clone("Rate1");
	...
	Rate1->Sumw2();
      ...
      Rate1->SetMarkerStyle(20);
      Rate1->SetMarkerSize(0.8);
      Rate1->SetXTitle("< Nbcs > HE depth1                       iBCN \b");
      Rate1->SetMarkerColor(2);
      Rate1->SetLineColor(0);
      Rate1->Draw("Error");

      c1->cd(4);
      TH1F *twod1= (TH1F*)hfile1->Get("h_bcnnbadchannels_depth2_HE");
      TH1F *twod0= (TH1F*)hfile1->Get("h_bcnbadrate0_depth2_HE");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate1 = (TH1F*)twod1->Clone("Rate1");
	...
	Rate1->Sumw2();
      ...
      Rate1->SetMarkerStyle(20);
      Rate1->SetMarkerSize(0.8);
      Rate1->SetXTitle("< Nbcs > HE depth2                       iBCN \b");
      Rate1->SetMarkerColor(2);
      Rate1->SetLineColor(0);
      Rate1->Draw("Error");

      c1->cd(5);
      TH1F *twod1= (TH1F*)hfile1->Get("h_bcnnbadchannels_depth3_HE");
      TH1F *twod0= (TH1F*)hfile1->Get("h_bcnbadrate0_depth3_HE");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate1 = (TH1F*)twod1->Clone("Rate1");
	...
	Rate1->Sumw2();
      ...
      Rate1->SetMarkerStyle(20);
      Rate1->SetMarkerSize(0.8);
      Rate1->SetXTitle("< Nbcs > HE depth3                       iBCN \b");
      Rate1->SetMarkerColor(2);
      Rate1->SetLineColor(0);
      Rate1->Draw("Error");

      c1->cd(6);
      TH1F *twod1= (TH1F*)hfile1->Get("h_bcnnbadchannels_depth1_HF");
      TH1F *twod0= (TH1F*)hfile1->Get("h_bcnbadrate0_depth1_HF");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate1 = (TH1F*)twod1->Clone("Rate1");
	...
	Rate1->Sumw2();
      ...
      Rate1->SetMarkerStyle(20);
      Rate1->SetMarkerSize(0.8);
      Rate1->SetXTitle("< Nbcs > HF depth1                       iBCN \b");
      Rate1->SetMarkerColor(2);
      Rate1->SetLineColor(0);
      Rate1->Draw("Error");
	...
	if(ccc1>0.) {
      ...
      c1->cd(7);
      TH1F *twod1= (TH1F*)hfile1->Get("h_bcnnbadchannels_depth2_HF");
      TH1F *twod0= (TH1F*)hfile1->Get("h_bcnbadrate0_depth2_HF");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate1 = (TH1F*)twod1->Clone("Rate1");
	...
	Rate1->Sumw2();
      ...
      Rate1->SetMarkerStyle(20);
      Rate1->SetMarkerSize(0.8);
      Rate1->SetXTitle("< Nbcs > HF depth2                       iBCN \b");
      Rate1->SetMarkerColor(2);
      Rate1->SetLineColor(0);
      Rate1->Draw("Error");

      c1->cd(8);
      TH1F *twod1= (TH1F*)hfile1->Get("h_bcnnbadchannels_depth4_HO");
      TH1F *twod0= (TH1F*)hfile1->Get("h_bcnbadrate0_depth4_HO");
      twod1->Sumw2();
      twod0->Sumw2();
      if(twod0->IsA()->InheritsFrom("TH1F")){
	TH1F* Rate1 = (TH1F*)twod1->Clone("Rate1");
	...
	Rate1->Sumw2();
      ...
      Rate1->SetMarkerStyle(20);
      Rate1->SetMarkerSize(0.8);
      Rate1->SetXTitle("< Nbcs > HO depth4                       iBCN \b");
      Rate1->SetMarkerColor(2);
      Rate1->SetLineColor(0);
      Rate1->Draw("Error");
