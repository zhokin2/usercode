...
int main(int argc, char *argv[])
{
  ...
  //
  const Int_t NMethods =7;// total number of Methods (all-together 37 methods)
  const Int_t NMethodsStart =0;     // since which method to start ( min=  0)
  const Int_t NMethodsToUse =6;// choose Number of methods to use ( max= 36)
  //
 TString MethodName[NMethods] = { "PLOT0", "PLOT1", "PLOT2", "PLOT3", "PLOT4", "PLOT5" , "PLOT6" };
  //______________________________________________________________________________________________________________________________    
  //______________________________________________________________________________________________________________________________    
 //////////////////////////////////////////////////////////////////////////////////////////////////////////////////  LED runs:
...
*/
 ...
 /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
 //"296808","296906","296909","296911","297026","297027","297028","297082","297087","297522",
 //"297571","297630","297645",
...
//	cout << "jjj= " << jjj << "     jjj-NMINmM= " << jjj-NMINmM << "     LEDrunsM[jjj]= " << LEDrunsM[jjj] << "     X0M[jjj]= " << X0M[jjj] <<endl;
  ...
  TH1F* NotEmptyDepthes = new TH1F("NotEmptyDepthes","", 59, 0.,59.);
...
*/
      ...
      TH2F* Ceff4= (TH2F*)twod3->Clone("Ceff4");
      TH2F* Ceff5= (TH2F*)twod3->Clone("Ceff5");
      TH2F* Ceff6= (TH2F*)twod3->Clone("Ceff6");
      TH2F* Ceff7= (TH2F*)twod3->Clone("Ceff7");

    // <Aijk>_runevents:
    Ceff1->Divide(twod1,t0010, 1, 1, "B");  
    Ceff2->Divide(twod2,t0020, 1, 1, "B");  
    Ceff3->Divide(twod3,t0030, 1, 1, "B");  
    Ceff4->Divide(twod3,t0040, 1, 1, "B");  
    Ceff5->Divide(twod3,t0050, 1, 1, "B");  
    Ceff6->Divide(twod3,t0060, 1, 1, "B");  
    Ceff7->Divide(twod3,t0070, 1, 1, "B");  
    ...
    //  PRINTOUT ONLY:
    if(verbosity == 2 ){
      cout<<"************* k1 = " << k1 << "    nx = " << nx <<"  ny = " << ny <<endl;
      Int_t depthtotalcount = 0;
      Int_t etamindepth1 = 999;Int_t etamaxdepth1 = 0;Int_t etamindepth2 = 999;Int_t etamaxdepth2 = 0;Int_t etamindepth3 = 999;Int_t etamaxdepth3 = 0;
      Int_t etamindepth4 = 999;Int_t etamaxdepth4 = 0;Int_t etamindepth5 = 999;Int_t etamaxdepth5 = 0;Int_t etamindepth6 = 999;Int_t etamaxdepth6 = 0;Int_t etamindepth7 = 999;Int_t etamaxdepth7 = 0;
      Int_t phimindepth1 = 999;Int_t phimaxdepth1 = 0;Int_t phimindepth2 = 999;Int_t phimaxdepth2 = 0;Int_t phimindepth3 = 999;Int_t phimaxdepth3 = 0;
      Int_t phimindepth4 = 999;Int_t phimaxdepth4 = 0;Int_t phimindepth5 = 999;Int_t phimaxdepth5 = 0;Int_t phimindepth6 = 999;Int_t phimaxdepth6 = 0;Int_t phimindepth7 = 999;Int_t phimaxdepth7 = 0;
      for (int jjj=0;jjj<=nx;jjj++) {
	for (int kkk=0;kkk<=ny;kkk++) {
	  if( Ceff1->GetBinContent(jjj,kkk) != 0.) {if(jjj<etamindepth1) etamindepth1=jjj;if(jjj>etamaxdepth1) etamaxdepth1=jjj;if(kkk<phimindepth1) phimindepth1=kkk;if(kkk>phimaxdepth1) phimaxdepth1=kkk;depthtotalcount++;}
	  if( Ceff2->GetBinContent(jjj,kkk) != 0.) {if(jjj<etamindepth2) etamindepth2=jjj;if(jjj>etamaxdepth2) etamaxdepth2=jjj;if(kkk<phimindepth2) phimindepth2=kkk;if(kkk>phimaxdepth2) phimaxdepth2=kkk;depthtotalcount++;}
	  if( Ceff3->GetBinContent(jjj,kkk) != 0.) {if(jjj<etamindepth3) etamindepth3=jjj;if(jjj>etamaxdepth3) etamaxdepth3=jjj;if(kkk<phimindepth3) phimindepth3=kkk;if(kkk>phimaxdepth3) phimaxdepth3=kkk;depthtotalcount++;}
	  if( Ceff4->GetBinContent(jjj,kkk) != 0.) {if(jjj<etamindepth4) etamindepth4=jjj;if(jjj>etamaxdepth4) etamaxdepth4=jjj;if(kkk<phimindepth4) phimindepth4=kkk;if(kkk>phimaxdepth4) phimaxdepth4=kkk;depthtotalcount++;}
	  if( Ceff5->GetBinContent(jjj,kkk) != 0.) {if(jjj<etamindepth5) etamindepth5=jjj;if(jjj>etamaxdepth5) etamaxdepth5=jjj;if(kkk<phimindepth5) phimindepth5=kkk;if(kkk>phimaxdepth5) phimaxdepth5=kkk;depthtotalcount++;}
	  if( Ceff6->GetBinContent(jjj,kkk) != 0.) {if(jjj<etamindepth6) etamindepth6=jjj;if(jjj>etamaxdepth6) etamaxdepth6=jjj;if(kkk<phimindepth6) phimindepth6=kkk;if(kkk>phimaxdepth6) phimaxdepth6=kkk;depthtotalcount++;}
	  if( Ceff7->GetBinContent(jjj,kkk) != 0.) {if(jjj<etamindepth7) etamindepth7=jjj;if(jjj>etamaxdepth7) etamaxdepth7=jjj;if(kkk<phimindepth7) phimindepth7=kkk;if(kkk>phimaxdepth7) phimaxdepth7=kkk;depthtotalcount++;}
	}//jjj
      }//kkk
      cout<< " final: depthtotalcount = " << depthtotalcount <<endl;
      cout<<"  etamindepth1= " << etamindepth1 <<"  etamaxdepth1= " << etamaxdepth1 <<"  phimindepth1= " << phimindepth1 <<"  phimaxdepth1= " << phimaxdepth1 <<endl;
      cout<<"  etamindepth2= " << etamindepth2 <<"  etamaxdepth2= " << etamaxdepth2 <<"  phimindepth2= " << phimindepth2 <<"  phimaxdepth2= " << phimaxdepth2 <<endl;
      cout<<"  etamindepth3= " << etamindepth3 <<"  etamaxdepth3= " << etamaxdepth3 <<"  phimindepth3= " << phimindepth3 <<"  phimaxdepth3= " << phimaxdepth3 <<endl;
      cout<<"  etamindepth4= " << etamindepth4 <<"  etamaxdepth4= " << etamaxdepth4 <<"  phimindepth4= " << phimindepth4 <<"  phimaxdepth4= " << phimaxdepth4 <<endl;
      cout<<"  etamindepth5= " << etamindepth5 <<"  etamaxdepth5= " << etamaxdepth5 <<"  phimindepth5= " << phimindepth5 <<"  phimaxdepth5= " << phimaxdepth5 <<endl;
      cout<<"  etamindepth6= " << etamindepth6 <<"  etamaxdepth6= " << etamaxdepth6 <<"  phimindepth6= " << phimindepth6 <<"  phimaxdepth6= " << phimaxdepth6 <<endl;
      cout<<"  etamindepth7= " << etamindepth7 <<"  etamaxdepth7= " << etamaxdepth7 <<"  phimindepth7= " << phimindepth7 <<"  phimaxdepth7= " << phimaxdepth7 <<endl;
  ...
  //                            82 bins
      for (int jjj=0;jjj<nx;jjj++) {
	for (int kkk=0;kkk<ny;kkk++) {
	  if(Ceff1->GetBinContent(jjj,kkk)> cutMinA && Ceff1->GetBinContent(jjj,kkk)< cutMaxA) mapRATIO[1][jjj][kkk+1] =  Ceff1->GetBinContent(jjj,kkk);
	  if(Ceff2->GetBinContent(jjj,kkk)> cutMinA && Ceff2->GetBinContent(jjj,kkk)< cutMaxA) mapRATIO[2][jjj][kkk+1] =  Ceff2->GetBinContent(jjj,kkk);
	  if(Ceff3->GetBinContent(jjj,kkk)> cutMinA && Ceff3->GetBinContent(jjj,kkk)< cutMaxA) mapRATIO[3][jjj][kkk+1] =  Ceff3->GetBinContent(jjj,kkk);
	  if(Ceff4->GetBinContent(jjj,kkk)> cutMinA && Ceff4->GetBinContent(jjj,kkk)< cutMaxA) mapRATIO[4][jjj][kkk+1] =  Ceff4->GetBinContent(jjj,kkk);
	  if(Ceff5->GetBinContent(jjj,kkk)> cutMinA && Ceff5->GetBinContent(jjj,kkk)< cutMaxA) mapRATIO[5][jjj][kkk+1] =  Ceff5->GetBinContent(jjj,kkk);
	  if(Ceff6->GetBinContent(jjj,kkk)> cutMinA && Ceff6->GetBinContent(jjj,kkk)< cutMaxA) mapRATIO[6][jjj][kkk+1] =  Ceff6->GetBinContent(jjj,kkk);
	  if(Ceff7->GetBinContent(jjj,kkk)> cutMinA && Ceff7->GetBinContent(jjj,kkk)< cutMaxA) mapRATIO[7][jjj][kkk+1] =  Ceff7->GetBinContent(jjj,kkk);
	}
      }
    //////////////////---------------------------------------
      /*
...
*/
    ...
    for (int jjj=1;jjj<=82;jjj++) {
      for (int kkk=1;kkk<=72;kkk++) {
	depthAVERAGEcount = 4 * (jjj-57) + (kkk-63);
  ...
  while (Method<NMethodsToUse+1) {
    ...
    if(Method == 3 ) {
      ...
      mapBADchannels->SetTitle("#eta - #phi SiPM channels");
...
//      if(verbosity == 4 ){
	...
	for (int jjj=0;jjj<=cx;jjj++) {
	  ...
	  if( BADruns->GetBinContent(jjj) >6.) cout<<"BADruns:   k1(0,...)= " <<      jjj      <<"  BADruns->GetBinContent(jjj)= " <<      BADruns->GetBinContent(jjj)      <<endl;
	}//jjj
//      }// if(verbosity == 2 )
    }//Method = 5
    
    //======================================================================================================= PLOT6:depthes with zero A
    if(Method == 6  ) {
      cout<<"****Draw 6 Dependencies: depthes with zero A   *** " <<endl;
      gPad->SetGridy();
      gPad->SetGridx();
      gPad->SetLogy();
      gStyle->SetOptStat(1110000); 
      ...
      NotEmptyDepthes->SetTitle("N of null depthes");
      NotEmptyDepthes->SetXTitle("depthes");
