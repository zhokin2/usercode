...
// mixture0:
      ...
      TH1F * Aeff0= (TH1F*)hfile->Get("h_ADCAmplZoom1_HE");
...
// mixture1:
	       TH1F * Aeff1= (TH1F*)hfile->Get("h_sumamplitudechannel_HE");
	     if(metkanodigicollection == 0 ) {
...
*/    
      // mixture2:
	       TH1F * Aeff2= (TH1F*)hfile->Get("h_eventamplitude_HE");
  ...
  while (Method<NMethodsToUse+1) {
	...
	gr1->Draw("P");
      ...
      TLegend leg(xx1,yy1,xx2,yy2, "HE: Rsignal vs irun");
      //      leg.AddEntry(gr1);
      leg.SetMargin( 0.3 );
      leg.SetBorderSize(1);
      leg.DrawClone("Same");
    ...
    if(Method == 6) {
      ...
      Aeff2D->SetXTitle("A-sub-detector x1000, adcCounts");
      Aeff2D->SetYTitle("N");
    ...
    if(Method == 14) {
      ...
      Aeff0D->SetXTitle("Aijk x90, adcCounts");
      Aeff0D->SetYTitle("N");
