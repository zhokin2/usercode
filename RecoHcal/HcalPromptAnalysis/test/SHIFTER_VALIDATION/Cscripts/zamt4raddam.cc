...
{
   //======================================================================
          TPostScript psfile ("zamt4raddam.ps", 111);
//
...
//void zamt4raddam() {
  ...
  Float_t XX[NMAX]{91.,93.,94.,103.,108.,117.,145.,161.,176.,192.,194.,203.,209.,223.,261.,264.,279.,282.,288.,294.,298.,338.,342.,353.,365.};// days of year
  //  XX[] ={91.,93.,94.,103.,108.,117.,145.,161.,176.,192.,194.,203.,209.,223.,261.,264.,279.,282.,288.,294.,298.,338.,342.,353.,365.};// time points
  //  XX = [91.,93.,94.,103.,108.,117.,145.,161.,176.,192.,194.,203.,209.,223.,261.,264.,279.,282.,288.,294.,298.,338.,342.,353.,365.];// time points
  Float_t YY[NMAX];// width averaged
  Float_t ZZ[NMAX];// ratio
  //______________________________________________________________________________
  // Create a new canvas.
  //  c1 = new TCanvas("zamt4raddam","Monte Carlo Study of Z scaling",200,10,700,900);
  c1 = new TCanvas("zamt4raddam","Monte Carlo Study of Z scaling",10,40,800,600);
  c1->Range(0,0,25,18);
  c1->SetFillColor(40);
...
////  pad2->Range(-0.43642,   -23.75,  3.92778,  -6.25);
  ...
  while (r1<NR) {
    ...
    Int_t NP = 3;  // for loop over time points(LED runs)
    ...
    for(int k1 = 0; k1<NP; k1++) {
      ...
      cout << "   k1 =  " <<k1<< endl;
      //      TFile *hfile;
            TFile *hfile= new TFile("/afs/cern.ch/cms/CAF/CMSALCA/ALCA_HCALCALIB/HCALMONITORING/RDMweb/histos/LED_194057.root", "READ");
      ...
      //
      //      TH2F *twod1;
      cout << "OPENED   Method = " <<Method<< endl;
      //h_mapTSmaxCalib_HB
      ...
      //
      cout << "11 h_mapDepth1Ampl_HB DONE" <<endl;
      //
	...
	//
      ...
      //	TH2F *twod1;
      //	TH2F *Ceff;
      TH2F *twod0= (TH2F*)hfile->Get("h_mapDepth1_HB");
      TH2F *twod1= (TH2F*)hfile->Get("h_mapRatioCalib_HB");
