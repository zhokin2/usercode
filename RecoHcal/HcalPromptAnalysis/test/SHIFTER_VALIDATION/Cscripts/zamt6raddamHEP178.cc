...
*/
   /*
   // 2018 all 
   "308784","308882","309237","309238","309318",
   "309321","309370","309573","309704","310262",
   "310268","310403","310410","310427","310452",
   "310454","310456"
*/
   // 2018
 ...
 //______________________________________________________________________________
  ...
  //      Float_t x1=0.00; Float_t x2=170.00;
   //       Float_t x1=0.00; Float_t x2=850.00;
          Float_t x1=0.00; Float_t x2=32.00;
...
//	cout << "jjj= " << jjj << "     jjj-NMINmM= " << jjj-NMINmM << "     LEDrunsM[jjj]= " << LEDrunsM[jjj] << "     X0M[jjj]= " << X0M[jjj] <<endl;
    ...
    //    Double_t cutMinA =15000.; Double_t cutMaxA = 40000.;  
    //   Double_t cutMinA =10000.; Double_t cutMaxA = 500000.;  
    //    Double_t cutMinA =20000.; Double_t cutMaxA = 250000.;  
    //    Double_t cutMinA =0.; Double_t cutMaxA = 999999999999.;
    //     Double_t cutMinA =1.; Double_t cutMaxA = 999999999999.;
...
//  TString fname = "/afs/cern.ch/cms/CAF/CMSALCA/ALCA_HCALCALIB/HCALMONITORING/RDMweb/histos/LASER_";
  ...
  TH1F* gainkoeff0= new TH1F("gainkoeff9","", 100, 0.9,1.1);
  ...
  //////////////////////////////////////////////////////////////////////////  LOOP    ratio current
      ...
      /////////////////////////////////////////////////////////////////////////////////////////      
    cout << "!!!!!!!!!!!!!!!!!!!!!! use root filrs from official RMT dir. " <<endl;
    /////////////////////////////////////////////////////////////////////////////////////////      
  ...
  //    	  TString epsName = "rootshunt1/LEDtest" + LEDruns[k1] + ".root";
      ...
      if(k1 == 2) {epsName = "rootshunt6/LEDtest" + LEDruns[k1] + ".root";}
      if(k1 == 3) {epsName = "rootshunt6/LEDtest" + LEDruns[k1] + ".root";}
      if(k1 == 4) {epsName = "rootshunt1/LEDtest" + LEDruns[k1] + ".root";}
      if(k1 == 5) {epsName = "rootshunt1/LEDtest" + LEDruns[k1] + ".root";}
      if(k1 == 6) {epsName = "rootshunt1/LEDtest" + LEDruns[k1] + ".root";}
      if(k1 == 7) {epsName = "rootshunt1/LEDtest" + LEDruns[k1] + ".root";}
      
309821     1       +        myself dir ~/raddam/rootshunt1&6        1
309676     1       +        elog dir ~/raddam/rootshunt1            5
309672     1       +        elog dir ~/raddam/rootshunt1            5
309669     1       +        elog dir ~/raddam/rootshunt1            5
309592     6       +        myself dir ~/raddam/rootshunt1&6        1
309573     6       -        elog dir ~/raddam/rootshunt6            1
309537     6       -        elog dir ~/raddam/rootshunt6            0.1
308786     1       +        myself dir ~/raddam/rootshunt1&6        1
*/
	...
	cout  <<" run = " << LEDruns[k1]  <<" k1= " << k1 <<" max bin value= " << maxvalueA <<endl;
