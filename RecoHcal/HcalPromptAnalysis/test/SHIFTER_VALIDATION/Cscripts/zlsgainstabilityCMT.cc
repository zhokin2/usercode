...
*/
    ...
    //======================================================================
      ...
      TH1F* ADCAmplLS0 = new TH1F("ADCAmplLS0","", 400, 0., 4000.);
      // i - # LSs:
      for (int i=1;i<=nx;i++) {
	// j - etaphi index:
      for (int j=1;j<ny;j++) {
	...
	if(ccc1>0.) {
      ...
      ADCAmplLS ->Draw("Error");
	    ...
	    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      c1->cd(3);
      TH1F* ADCAmplLS1 = new TH1F("ADCAmplLS1","", 250, 0., 500.);
      for (int i=1;i<=nx;i++) {
	// j - etaphi index:
      for (int j=1;j<ny;j++) {
	double ccc1 =  Cefz1->GetBinContent(i,j);
	...
	if(ccc1>0.) {
	  int jeta = (j-1)/72.;// jeta = 0-81
	  int jphi = (j-1)-72*jeta+1;// jphi=1-72; 
	  //	  int jeta = j/72.;// jeta = 0-81
	  //	  int jphi = j-72*jeta+1;// jphi=1-72; 
	  	  if(i==1) cout<<"HB  i= "<< i <<" j= "<< j <<"  jeta= "<< jeta-41 <<" jphi= "<< jphi-1 <<"  A= "<< ccc1/maxbinx <<endl;
	  //	  Cefz4 ->Fill(jeta-41,jphi-1,ccc1/maxbinx);
	  Cefz4 ->Fill(jeta-41,jphi-1,ccc1*maxbiny/sumijhb);
	}
      }}
	...
	for (int j=1;j<ny;j++) {
	  ...
	  //	    int jphi = j-72*jeta+1;// jphi=1-72; 
	    ...
	    if(jeta==30 && jphi==41) GainStability0 ->Fill(i,ccc1);
	    if(jeta==40 && jphi==41) GainStability1 ->Fill(i,ccc1);
	    if(jeta==50 && jphi==41) GainStability2 ->Fill(i,ccc1);
	  }
	}}
    ...
    //======================================================================
      ...
      // i - # LSs:
      TH1F* Sefw0 = new TH1F("Sefw0","", 7000, 0., 7000.);
      for (int i=1;i<=nx;i++) {
	// j - etaphi index:
      for (int j=1;j<ny;j++) {
	...
	if(ccc1>0.) {
      ...
      Sefw ->Draw("Error");
	    ...
	    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      c1->cd(3);
      TH1F* Sefw1 = new TH1F("Sefw1","", 2500, 0., 2500.);
      for (int i=1;i<=nx;i++) {
	// j - etaphi index:
      for (int j=1;j<ny;j++) {
	double ccc1 =  Sefz1->GetBinContent(i,j);
	...
	if(ccc1>0.) {
	  ...
	  //	  int jeta = j/72.;// jeta = 0-81
	  //	  int jphi = j-72*jeta+1;// jphi=1-72; 
	  	  if(i==1) cout<<"HE  i= "<< i <<" j= "<< j <<"  jeta= "<< jeta-41 <<" jphi= "<< jphi-1 <<"  A= "<< ccc1/maxbinx <<endl;
	  //	  Sefz4 ->Fill(jeta-41,jphi-1,ccc1/maxbinx);
	  Sefz4 ->Fill(jeta-41,jphi-1,ccc1*maxbiny/sumijhe);
	}
      }}
      gPad->SetGridy();      gPad->SetGridx();      //      gPad->SetLogz();
	...
	for (int j=1;j<ny;j++) {
	  ...
	  //	    int jphi = j-72*jeta+1;// jphi=1-72; 
	    ...
	    if(jeta==16 && jphi==41) Sefk0 ->Fill(i,ccc1);
	    if(jeta==20 && jphi==41) Sefk1 ->Fill(i,ccc1);
	    if(jeta==64 && jphi==41) Sefk2 ->Fill(i,ccc1);
	  }
	}}
    ...
    //======================================================================
      ...
      // i - # LSs:
      TH1F* Yefw0 = new TH1F("Yefw0","", 1000, 0., 1000.);
      for (int i=1;i<=nx;i++) {
	// j - etaphi index:
      for (int j=1;j<ny;j++) {
...
//  Yefw0->SetMinimum(10.);
	...
	Yefw ->Fill( float(i), sumsum);
      ...
      Yefw ->Draw("Error");
	    ...
	    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
      c1->cd(3);
      TH1F* Yefw1 = new TH1F("Yefw1","", 500, 0., 500.);
      for (int i=1;i<=nx;i++) {
	// j - etaphi index:
      for (int j=1;j<ny;j++) {
	double ccc1 =  Yefz1->GetBinContent(i,j);
	...
	if(ccc1>0.) {
	  ...
	  //	  int jphi = j-72*jeta+1;// jphi=1-72; 
	  	  ...
	  	  if(i==1) cout<<"HO  i= "<< i <<" j= "<< j <<"  jeta= "<< jeta-41 <<" jphi= "<< jphi-1 <<"  A= "<< ccc1/maxbinx <<endl;
	  //	  Yefz4 ->Fill(jeta-41,jphi-1,ccc1/maxbinx);
	  Yefz4 ->Fill(jeta-41,jphi-1,ccc1*maxbiny/sumijho);
	}
      }}
      gPad->SetGridy();      gPad->SetGridx();      //      gPad->SetLogz();
	...
	for (int j=1;j<ny;j++) {
	  ...
	  //	    int jphi = j-72*jeta+1;// jphi=1-72; 
	    ...
	    if(jeta==30 && jphi==41) Yefk0 ->Fill(i,ccc1);
	    if(jeta==40 && jphi==41) Yefk1 ->Fill(i,ccc1);
	    if(jeta==50 && jphi==41) Yefk2 ->Fill(i,ccc1);
	  }
	}}
    ...
    //======================================================================
      ...
      // i - # LSs:
      TH1F* Gefw0 = new TH1F("Gefw0","", 500, 0., 500.);
      for (int i=1;i<=nx;i++) {
	// j - etaphi index:
      for (int j=1;j<ny;j++) {
	...
	if(ccc1>0.) {
	  ...
	  //	  int jeta = j/72.;// jeta = 0-81
	  //	  int jphi = j-72*jeta+1;// jphi=1-72; 
	  	  if(i==1) cout<<"HF  i= "<< i <<" j= "<< j <<"  jeta= "<< jeta-41 <<" jphi= "<< jphi-1 <<"  A= "<< ccc1/maxbinx <<endl;
	  Gefz4 ->Fill(jeta-41,jphi-1,ccc1*maxbiny/sumijhf);
	...
	for (int j=1;j<ny;j++) {
	  ...
	  //	    int jphi = j-72*jeta+1;// jphi=1-72; 
	    ...
	    if(jeta== 3 && jphi==41) Gefk0 ->Fill(i,ccc1);
	    if(jeta== 5 && jphi==41) Gefk1 ->Fill(i,ccc1);
	    if(jeta== 9 && jphi==41) Gefk2 ->Fill(i,ccc1);
	  }
	}}
	...
	// i - # LSs:
	for (int i=1;i<=nx;i++) {double ccc1 =  Gefz1->GetBinContent(i,j);if(ccc1>0.){sumj += ccc1;nj++;} } meanj=sumj/nj;
	// i - # LSs:
	...
	for (int i=1;i<=nx;i++) {
	  ...
	  if(ccc1>0.) {
	    ...
	    if(jeta== 3 && jphi==41 && (ccc1<dif3rmsMIN || ccc1>dif3rmsMAX) ) Gefh0 ->Fill(i,ccc1);
	    if(jeta== 5 && jphi==41 && (ccc1<dif3rmsMIN || ccc1>dif3rmsMAX) ) Gefh1 ->Fill(i,ccc1);
	    if(jeta== 9 && jphi==41 && (ccc1<dif3rmsMIN || ccc1>dif3rmsMAX) ) Gefh2 ->Fill(i,ccc1);
	  }}}
