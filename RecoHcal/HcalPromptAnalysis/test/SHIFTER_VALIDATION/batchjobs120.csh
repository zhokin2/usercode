...
#cp Global_${2}_${3}.root /afs/cern.ch/cms/CAF/CMSALCA/ALCA_HCALCALIB/HCALMONITORING/RDMScript/CMSSW_10_1_11/src/RecoHcal/HcalPromptAnalysis/test/SHIFTER_VALIDATION/Global_${2}_${3}.root
cp Global_${2}_${3}.root /afs/cern.ch/cms/CAF/CMSALCA/ALCA_HCALCALIB/HCALMONITORING/RDMScript/CMSSW_10_1_11/src/RecoHcal/HcalPromptAnalysis/test/SHIFTER_VALIDATION/znoabortgap/Global_${2}_${3}.root
## rm all unnesecery
#rm log_${2} 
##rm Global.root
