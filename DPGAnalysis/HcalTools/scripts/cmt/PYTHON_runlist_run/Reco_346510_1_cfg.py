...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/510/00000/c4937ad9-0f5d-4ed0-9022-cf124035a959.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346510_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346510_1.root")
