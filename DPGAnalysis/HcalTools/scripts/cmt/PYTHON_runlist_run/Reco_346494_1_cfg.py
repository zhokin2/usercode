...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/494/00000/a50ae5eb-7aa2-4b4a-aabf-6c86df6793fc.root',
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/494/00000/9c55b6d9-a9bd-44a5-9c13-c209f6dfa1d2.root',
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/494/00000/3597c242-18c2-4c7e-a82b-b4d2e3bdcdea.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346494_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346494_1.root")
