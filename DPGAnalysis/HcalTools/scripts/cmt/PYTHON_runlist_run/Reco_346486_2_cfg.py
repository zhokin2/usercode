...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/486/00000/c212d35c-4ee9-4059-8875-e401ebfe4a82.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346486_2.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346486_2.root")
