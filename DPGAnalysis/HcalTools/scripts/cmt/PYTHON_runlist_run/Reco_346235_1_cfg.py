...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/235/00000/5832886c-2043-4e4d-90ac-0275d54a03b3.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346235_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346235_1.root")
