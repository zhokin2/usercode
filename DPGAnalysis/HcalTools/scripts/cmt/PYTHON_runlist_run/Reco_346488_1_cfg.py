...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/488/00000/f86a3907-602d-4790-8bb0-5e9e95f2cd68.root',
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/488/00000/4a728530-b488-4ed7-af6f-2b62dba779e8.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346488_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346488_1.root")
