...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/386/00000/62bcc137-c219-4b57-a793-406aba4a02a0.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346386_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346386_1.root")
