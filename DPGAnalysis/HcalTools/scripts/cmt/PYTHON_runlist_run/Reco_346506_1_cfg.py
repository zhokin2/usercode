...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/506/00000/e1e48eaf-e75c-4875-a35b-d6abd15fb2e0.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346506_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346506_1.root")
