...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/453/00000/9fb4fc63-0ffb-464e-8a56-8fa517eeb591.root',
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/453/00000/ed507e63-9f75-4120-b2d1-1c57af572120.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346453_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346453_1.root")
