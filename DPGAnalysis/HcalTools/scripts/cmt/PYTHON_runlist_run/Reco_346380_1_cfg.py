...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/380/00000/bb7a17f7-0b5e-4462-9ff9-7cb30d3a8805.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346380_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346380_1.root")
