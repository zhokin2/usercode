...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/238/00000/c502c512-d8d2-4301-8f74-88e7eb8af7ea.root',
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/238/00000/bac657de-390c-4019-9fec-2a0a00ad3429.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346238_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346238_1.root")
