...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/450/00000/0f88d142-a32f-46f3-b472-d78de201cfd3.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346450_2.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346450_2.root")
