...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/448/00000/d73f6a0d-1238-45e9-8ae9-16119002f333.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346448_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346448_1.root")
