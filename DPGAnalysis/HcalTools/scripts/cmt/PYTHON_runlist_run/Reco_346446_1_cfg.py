...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/446/00000/b93a465b-1cc1-4e70-b779-2e9e144bcfd6.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346446_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346446_1.root")
