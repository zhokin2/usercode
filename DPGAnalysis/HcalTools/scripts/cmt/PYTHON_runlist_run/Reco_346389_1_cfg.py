...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/389/00000/7dcbc847-0842-4701-80a2-1326c18e8743.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346389_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346389_1.root")
