...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/382/00000/cfa90f15-5c6e-45c4-a83b-11fb2bcf558b.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346382_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346382_1.root")
