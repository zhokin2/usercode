...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/237/00000/958ca573-68b4-4ac0-9f2e-7e9f9b6a8389.root',
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/237/00000/2d3ae7ea-8baa-455c-aa65-851b6d41de6a.root',
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/237/00000/a13f0e3d-ef36-4319-aade-a3607d2bd382.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346237_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346237_1.root")
