...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/449/00000/de493f04-cb00-4e86-9d2d-5aefddae55e4.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346449_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346449_1.root")
