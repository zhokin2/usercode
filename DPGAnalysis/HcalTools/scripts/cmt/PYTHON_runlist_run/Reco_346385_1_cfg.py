...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/385/00000/169c2b78-9065-463e-9402-8cfb7b503c7e.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346385_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346385_1.root")
