...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/305/00000/5bc68194-75e6-4d9e-87f0-3c2d8b79a6f2.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346305_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346305_1.root")
