...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/375/00000/182e50bf-1296-4f74-815a-be1353f54785.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346375_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346375_1.root")
