...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/383/00000/a4d69a30-be51-4a5e-94ff-d5f18d2e66b9.root',
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/383/00000/aff1bbee-fea0-44a6-b5ba-fe4b5406c700.root',
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/383/00000/56fa75df-a867-4e8c-aae1-cfe0973f8871.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346383_2.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346383_2.root")
