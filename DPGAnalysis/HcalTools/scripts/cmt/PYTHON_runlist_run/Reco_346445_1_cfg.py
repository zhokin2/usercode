...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/445/00000/2498da16-9975-4f20-9046-cd6360d29a50.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346445_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346445_1.root")
