...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/381/00000/a8478c3d-d44b-4de2-b065-224242cd5d81.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346381_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346381_1.root")
