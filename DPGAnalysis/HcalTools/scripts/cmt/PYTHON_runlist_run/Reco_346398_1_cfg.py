...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/398/00000/dea27040-8333-4384-bbae-c77629deac94.root',
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/398/00000/3a3cf1ef-1fd7-49d7-8d96-9b728082aff0.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346398_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346398_1.root")
