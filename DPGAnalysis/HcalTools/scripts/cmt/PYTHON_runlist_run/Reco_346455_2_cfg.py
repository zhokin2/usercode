...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/455/00000/0aaab5d6-d5dd-4d0a-a132-688a634833f3.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346455_2.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346455_2.root")
