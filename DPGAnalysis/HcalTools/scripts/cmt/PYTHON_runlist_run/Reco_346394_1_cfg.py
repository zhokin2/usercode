...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/394/00000/89f07295-6323-4cc6-943a-b4743f533457.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346394_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346394_1.root")
