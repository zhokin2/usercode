...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/302/00000/2f4c28a7-6a8a-49bb-b18e-f6c458918775.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346302_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346302_1.root")
