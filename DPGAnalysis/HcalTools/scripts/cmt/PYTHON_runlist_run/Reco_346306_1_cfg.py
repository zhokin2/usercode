...
'/store/data/Commissioning2021/MinimumBias/RAW/v1/000/346/306/00000/fdd8101e-e527-4f1b-952d-bd477da4c4e5.root',
    ),
...
process.Analyzer = cms.EDAnalyzer("CMTRawAnalyzer",
				  ...
				  calibrRatioHFMax = cms.double(0.8),
                                  ...
                                  #HistOutFile = cms.untracked.string('Global_346306_1.root'),
                                  #
...
process.TFileService = cms.Service("TFileService",
      fileName = cms.string("Global_346306_1.root")
